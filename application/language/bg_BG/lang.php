...
$lang['L_ACTUALLY_INSERTED_RECORDS']="Добавени са <b>%s</b>"<br />    ." записа.";
$lang['L_ACTUALLY_INSERTED_RECORDS_OF']="Добавени са <b>%s</b> от"<br />    ." <b>%s</b> записи.";
$lang['L_ADD']="Добави";
...
$lang['L_ANALYZING_TABLE']="Данните в таблица"<br />    ." '<b>%s</b>' се анализират.";
$lang['L_ASKDBCOPY']="Желаете ли да"<br />    ." копирате"<br />    ." информацията"<br />    ." (таблици и данни) от"<br />    ." БД `%s` в БД `%s`?";
$lang['L_ASKDBDELETE']="Желаете ли да"<br />    ." изтриете БД `%s`"<br />    ." заедно със"<br />    ." съдържанието й?";
$lang['L_ASKDBEMPTY']="Желаете ли да"<br />    ." изпразните БД `%s`?";
$lang['L_ASKDELETEFIELD']="Желаете ли да"<br />    ." изтриете полето?";
$lang['L_ASKDELETERECORD']="Сигурни ли сте, че"<br />    ." искате да изтриете"<br />    ." този запис?";
$lang['L_ASKDELETETABLE']="Да се изтрие ли"<br />    ." таблица `%s`?";
$lang['L_ASKTABLEEMPTY']="Да се изпразни ли"<br />    ." таблица `%s`?";
$lang['L_ASKTABLEEMPTYKEYS']="Да се изпразни ли"<br />    ." таблица `%s` и да се"<br />    ." рестартират"<br />    ." индеските?";
...
$lang['L_AUTODELETE']="Изтриване на"<br />    ." архивите"<br />    ." автоматично";
$lang['L_BACK']="Назад";
$lang['L_BACKUPFILESANZAHL']="В директорията с"<br />    ." архиви има";
$lang['L_BACKUPS']="Архиви";
$lang['L_BACKUP_DBS']="БДи за архив";
$lang['L_BACKUP_TABLE_DONE']="Архивирането на"<br />    ." таблица `%s` завърши."<br />    ." Архивирани са %s"<br />    ." записа.";
$lang['L_BACK_TO_OVERVIEW']="Преглед на БД";
$lang['L_CALL']="Извикай";
$lang['L_CANCEL']="Отказ";
$lang['L_CANT_CREATE_DIR']="Директорията '%s' не"<br />    ." може да бъде"<br />    ." създадена. Моля,"<br />    ." използвайте FTP"<br />    ." програма.";
$lang['L_CHANGE']="Промени";
$lang['L_CHANGEDIR']="Промени директория";
$lang['L_CHANGEDIRERROR']="Не може де се промени"<br />    ." директорията!";
$lang['L_CHARSET']="Символна подребда";
$lang['L_CHARSETS']="Character Sets";
$lang['L_CHECK']="Провери";
$lang['L_CHECK_DIRS']="Провери моите"<br />    ." директории";
...
$lang['L_CONFIGFILE']="Конфигурационен"<br />    ." файл";
$lang['L_CONFIGFILES']="Конфигурационни"<br />    ." файлове";
$lang['L_CONFIGURATIONS']="Конфигурации";
$lang['L_CONFIG_AUTODELETE']="Автоматично"<br />    ." изтриване";
$lang['L_CONFIG_CRONPERL']="Crondump Settings for Perl script";
$lang['L_CONFIG_EMAIL']="Email Notification";
$lang['L_CONFIG_FTP']="FTP трансфер на"<br />    ." архивния файл";
$lang['L_CONFIG_HEADLINE']="Configuration";
$lang['L_CONFIG_INTERFACE']="Interface";
$lang['L_CONFIG_LOADED']="Конфигурацията \"%s\" е"<br />    ." внесена успешно.";
