...
$lang['L_ACTIVATED']="Активиран";
$lang['L_ACTUALLY_INSERTED_RECORDS']="Добавени са <b>%s</b>"
    ." записа.";
$lang['L_ACTUALLY_INSERTED_RECORDS_OF']="Добавени са <b>%s</b> от"
    ." <b>%s</b> записи.";
$lang['L_ADD']="Добави";
$lang['L_ADDED']="Добавен";
$lang['L_ADD_DB_MANUALLY']="Добави БД ръчно";
$lang['L_ADD_RECIPIENT']="Добави получател";
$lang['L_ALL']="Всичко";
$lang['L_ANALYZE']="Анализирай";
$lang['L_ANALYZING_TABLE']="Данните в таблица"
    ." '<b>%s</b>' се анализират.";
$lang['L_ASKDBCOPY']="Желаете ли да"
    ." копирате"
    ." информацията"
    ." (таблици и данни) от"
    ." БД `%s` в БД `%s`?";
$lang['L_ASKDBDELETE']="Желаете ли да"
    ." изтриете БД `%s`"
    ." заедно със"
    ." съдържанието й?";
...
$lang['L_ASKTABLEEMPTYKEYS']="Да се изпразни ли"
    ...
    ." рестартират"
    ." индеските?";
$lang['L_ATTACHED_AS_FILE']="прикачен като файл";
$lang['L_ATTACH_BACKUP']="Прикачи архив";
$lang['L_AUTHENTICATE']="Данни за вход";
$lang['L_AUTHORIZE']="Ауторизирай";
$lang['L_AUTODELETE']="Изтриване на"
    ." архивите"
    ." автоматично";
$lang['L_BACK']="Назад";
$lang['L_BACKUPFILESANZAHL']="В директорията с"
    ." архиви има";
$lang['L_BACKUPS']="Архиви";
$lang['L_BACKUP_DBS']="БДи за архив";
$lang['L_BACKUP_TABLE_DONE']="Архивирането на"
    ." таблица `%s` завърши."
    ." Архивирани са %s"
    ." записа.";
$lang['L_BACK_TO_OVERVIEW']="Преглед на БД";
$lang['L_CALL']="Извикай";
$lang['L_CANCEL']="Отказ";
$lang['L_CANT_CREATE_DIR']="Директорията '%s' не"
    ." може да бъде"
    ." създадена. Моля,"
    ." използвайте FTP"
    ." програма.";
$lang['L_CHANGE']="Промени";
$lang['L_CHANGEDIR']="Промени директория";
$lang['L_CHANGEDIRERROR']="Не може де се промени"
    ." директорията!";
$lang['L_CHARSET']="Символна подребда";
$lang['L_CHARSETS']="Character Sets";
$lang['L_CHECK']="Провери";
$lang['L_CHECK_DIRS']="Провери моите"
    ." директории";
$lang['L_CHOOSE_CHARSET']="MySQLDumper couldn't detect the"
    ...
    ." />Good luck. ;)<br /><br />";
$lang['L_CHOOSE_DB']="Избери БД";
$lang['L_CLEAR_DATABASE']="Изчисти БД";
$lang['L_CLOSE']="Затвори";
$lang['L_COLLATION']="Колация";
$lang['L_COMMAND']="Команда";
$lang['L_COMMAND_AFTER_BACKUP']="Команда след архив";
$lang['L_COMMAND_BEFORE_BACKUP']="Команда преди архив";
$lang['L_COMMENT']="Коментар";
$lang['L_COMPRESSED']="компресиране (gz)";
$lang['L_CONFBASIC']="Основен параметър";
$lang['L_CONFIG']="Конфигурация";
$lang['L_CONFIGFILE']="Конфигурационен"
    ." файл";
$lang['L_CONFIGFILES']="Конфигурационни"
    ." файлове";
$lang['L_CONFIGURATIONS']="Конфигурации";
$lang['L_CONFIG_AUTODELETE']="Автоматично"
    ." изтриване";
$lang['L_CONFIG_CRONPERL']="Crondump Settings for Perl script";
$lang['L_CONFIG_EMAIL']="Email Notification";
$lang['L_CONFIG_FTP']="FTP трансфер на"
    ." архивния файл";
$lang['L_CONFIG_HEADLINE']="Configuration";
$lang['L_CONFIG_INTERFACE']="Interface";
$lang['L_CONFIG_LOADED']="Конфигурацията \"%s\" е"
    ." внесена успешно.";
...
$lang['L_LANGUAGE_NAME']="Български";
...
$lang['L_MULTIPART_SIZE']="maximum File size";
