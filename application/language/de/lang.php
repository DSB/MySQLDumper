...
$lang['L_DATABASE_CREATED_FAILED']="Die Datenbank wurde nicht"
    ." erstellt.
...
Alternativ können Sie"
    ." auf die MySQLDumper-Version 1.24"
...
$lang['L_NOT_SUPPORTED']="Dieses Backup unterstützt diese"
    ." Funktion nicht.";
$lang['L_NO_DB_FOUND']="Es wurde keine Datenbank"
    ." gefunden.
Blenden Sie die"
...
$lang['L_PHP_VERSION_TOO_OLD']="Es tut uns leid: die PHP-Version ist"
    ...
    ." zu können.
PHP muss in der Version %s"
    ." oder höher installiert sein. Die auf"
    ." diesem Server installierte PHP-Version"
    ." %s ist leider zu alt.
Die PHP-Version"
    ." muss aktualisiert werden, bevor"
    ." MySQLDumper installiert und genutzt"
    ." werden kann.";
...
$lang['L_POSSIBLE_COLLATIONS_EXPLAIN']="Dies sind die für diesen Zeichensatz"
    ." möglichen Sortierregeln.

_cs = case"
    ." sensitiv -> Groß-/Kleinschreibung"
    ." wird unterschieden
_ci = case"
...
Sie können Benutzername"
    ." und Kennwort frei wählen. Achten Sie"
    ." jedoch darauf, eine möglichst sichere"
    ." Kombination von Benutzername und"
    ." Kennwort zu wählen, um den Zugang zu"
    ." MySQLDumper bestmöglich vor"
