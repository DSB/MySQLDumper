 ...
 * @version       $Rev$
 * @author        $Author$
 * Maintained by: DSB (283), JanRei (23), Kyoya (31), StvN (2)
 */
$lang=array(
'L_ACTION' => 'Aktion',
...
'L_ANALYZING_TABLE' => 'Momentan werden Daten der Tabelle \'<b>%s</b>\' analysiert.',
'L_ASKDBCOPY' => 'Soll der Inhalt der Datenbank `%s` in die Datenbank `%s` kopiert werden?',
'L_ASKDBDELETE' => 'Soll die Datenbank `%s` samt Inhalt wirklich gelöscht werden?',
'L_ASKDBEMPTY' => 'Soll die Datenbank `%s` wirklich geleert werden?',
'L_ASKDELETEFIELD' => 'Soll das Feld gelöscht werden?',
'L_ASKDELETERECORD' => 'Soll der Datensatz gelöscht werden?',
'L_ASKDELETETABLE' => 'Soll die Tabelle `%s` gelöscht werden?',
'L_ASKTABLEEMPTY' => 'Soll die Tabelle `%s` geleert werden?',
'L_ASKTABLEEMPTYKEYS' => 'Sollen die Tabelle `%s` geleert und die Indizes zurückgesetzt werden?',
'L_ATTACHED_AS_FILE' => 'als Datei angehängt',
'L_ATTACH_BACKUP' => 'Backup anhängen',
'L_AUTHENTICATE' => 'Anmeldeinformationen',
...
'L_CONFIG_CRONPERL' => 'Crondump-Einstellungen für das Perlscript',
...
'L_CONFIG_LOADED' => 'Die Konfiguration "%s" wurde erfolgreich geladen.',
'L_CONFIRM_CONFIGFILE_DELETE' => 'Soll die Konfigurationsdatei %s wirklich gelöscht werden?',
'L_CONFIRM_DELETE_FILE' => 'Soll die Datei \'%s\' wirklich gelöscht werden?',
'L_CONFIRM_DELETE_TABLES' => 'Sollen die gewählten Tabellen wirklich gelöscht werden?',
'L_CONFIRM_DROP_DATABASES' => 'Soll/en die gewählte/n Datenbank/en wirklich gelöscht werden?<br /><br />Achtung: alle Daten gehen unwiderruflich verloren! Legen Sie sicherheitshalber vorher eine Sicherung der Daten an.',
'L_CONFIRM_RECIPIENT_DELETE' => 'Soll der Empfänger "%s" wirklich entfernt werden?',
'L_CONFIRM_TRUNCATE_DATABASES' => 'Soll/en die gewählte/n Datenbank/en wirklich geleert werden?<br /><br />Achtung: alle Tabellen gehen unwiderruflich verloren! Legen Sie sicherheitshalber vorher eine Sicherung der Daten an.',
'L_CONFIRM_TRUNCATE_TABLES' => 'Sollen die gewählten Tabellen wirklich geleert werden?',
'L_CONNECT' => 'verbinden',
'L_CONNECTIONPARS' => 'Verbindungsparameter',
'L_CONNECTTOMYSQL' => 'zu MySQL verbinden',
'L_CONTINUE_MULTIPART_RESTORE' => 'Multipart-Wiederherstellung mit nächster Datei \'%s\' fortfahren .',
...
'L_CONVERT_FINISHED' => 'Konvertierung abgeschlossen, \'%s\' wurde erzeugt.',
'L_CONVERT_START' => 'Konvertierung starten',
'L_CONVERT_TITLE' => 'Konvertiere Dump ins MSD-Format',
'L_CONVERT_WRONG_PARAMETERS' => 'Falsche Parameter! Konvertierung ist nicht möglich.',
'L_CREATE' => 'anlegen',
'L_CREATED' => 'Erstellt',
'L_CREATEDIRS' => 'erstelle Verzeichnisse',
'L_CREATE_AUTOINDEX' => 'Autoindex erzeugen',
...
'L_CSV_ERRORCREATETABLE' => 'Fehler beim Erstellen der Tabelle `%s`!',
'L_CSV_FIELDCOUNT_NOMATCH' => 'Die Anzahl der Tabellenfelder stimmen nicht mit den zu importierenden Daten überein (%d statt %d).',
...
'L_CSV_FIELDSLINES' => '%d Felder ermittelt, insgesamt %d Zeilen',
...
'L_DATABASES_OF_USER' => 'Datenbanken des Benutzers',
'L_DATABASE_CREATED_FAILED' => 'Die Datenbank wurde nicht erstellt.<br />MySQL lieferte folgenden Fehler:<br/><br />%s',
'L_DATABASE_CREATED_SUCCESS' => 'Die Datenbank \'%s\' wurde erfolgreich erstellt.',
'L_DATASIZE' => 'Datengröße',
'L_DATASIZE_INFO' => 'Dies ist die Größe der Datensätze - nicht die Größe der Sicherungsdatei',
'L_DAY' => 'Tag',
'L_DAYS' => 'Tage',
'L_DB' => 'Datenbank',
...
'L_DB_DEFAULT' => 'Standarddatenbank',
'L_DB_HOST' => 'Datenbank-Hostname',
'L_DB_IN_LIST' => 'Die Datenbank \'%s\' konnte nicht hinzugefügt werden, da sie bereits vorhanden ist.',
'L_DB_NAME' => 'Datenbankname',
'L_DB_PASS' => 'Datenbank-Passwort',
'L_DB_SELECT_ERROR' => '<br />Fehler:<br />Auswahl der Datenbank \'<b>',
'L_DB_SELECT_ERROR2' => '</b>\' fehlgeschlagen!',
'L_DB_USER' => 'Datenbank-Benutzer',
'L_DEFAULT_CHARACTER_SET_NAME' => 'Standardzeichensatz',
'L_DEFAULT_CHARSET' => 'Standardzeichensatz',
'L_DEFAULT_COLLATION_NAME' => 'Standardsortierung',
'L_DELETE' => 'Lösche',
'L_DELETE_DATABASE' => 'Datenbank löschen',
'L_DELETE_FILE_ERROR' => 'Die Datei "%s" konnte nicht gelöscht werden!',
'L_DELETE_FILE_SUCCESS' => 'Die Datei "%s" wurde erfolgreich gelöscht.',
'L_DELETE_HTACCESS' => 'Verzeichnisschutz entfernen (.htaccess löschen)',
'L_DESCRIPTION' => 'Beschreibung',
'L_DESELECT_ALL' => 'Auswahl aufheben',
'L_DIR' => 'Verzeichnis',
...
'L_DUMP' => 'Backup',
'L_DUMP_ENDERGEBNIS' => 'Es wurden <b>%s</b> Tabellen mit insgesamt <b>%s</b> Datensätzen gesichert.<br />',
'L_DUMP_FILENAME' => 'Backup-Datei',
'L_DUMP_HEADLINE' => 'erzeuge Backup...',
'L_DUMP_NOTABLES' => 'Es konnten keine Tabellen in der Datenbank `%s` gefunden werden.',
'L_DUMP_OF_DB_FINISHED' => 'Sicherung der Datenbank `%s` abgeschlossen',
'L_DURATION' => 'Dauer',
'L_EDIT' => 'editieren',
'L_EHRESTORE_CONTINUE' => 'fortfahren und Fehler protokollieren',
'L_EHRESTORE_STOP' => 'anhalten',
'L_EMAIL' => 'E-Mail',
'L_EMAILBODY_ATTACH' => 'In der Anlage finden Sie die Sicherung Ihrer MySQL-Datenbank.<br />Sicherung der Datenbank `%s`<br /><br /><br />Folgende Datei wurde erzeugt:<br /><br />%s <br /><br />Viele Grüße<br /><br />MySQLDumper<br />',
'L_EMAILBODY_FOOTER' => '<br /><br /><br />Viele Grüße<br /><br />MySQLDumper<br />',
'L_EMAILBODY_MP_ATTACH' => 'Es wurde eine Multipart-Sicherung erstellt.<br />Die Sicherungen werden in separaten E-Mails als Anhang geliefert!<br />Sicherung der Datenbank `%s`<br /><br /><br />Folgende Dateien wurden erzeugt:<br /><br />%s<br /><br /><br />Viele Grüße<br /><br />MySQLDumper<br />',
'L_EMAILBODY_MP_NOATTACH' => 'Es wurde eine Multipart-Sicherung erstellt.<br />Die Sicherungen werden nicht als Anhang mitgeliefert!<br />Sicherung der Datenbank `%s`<br /><br /><br />Folgende Dateien wurden erzeugt:<br /><br />%s<br /><br /><br />Viele Grüße<br /><br />MySQLDumper<br />',
'L_EMAILBODY_NOATTACH' => 'Das Backup wurde nicht angehängt.<br />Sicherung der Datenbank `%s`<br /><br /><br />Folgende Datei wurde erzeugt:<br /><br />%s<br /><br /><br />Viele Grüße<br /><br />MySQLDumper<br />',
'L_EMAILBODY_TOOBIG' => 'Die Sicherung überschreitet die Maximalgröße von %s und wurde daher nicht angehängt.<br />Sicherung der Datenbank `%s`<br /><br /><br />Folgende Datei wurde erzeugt:<br /><br />%s<br /><br /><br />Viele Grüße<br /><br />MySQLDumper<br />',
...
'L_EMAIL_WAS_SEND' => 'Die E-Mail wurde erfolgreich verschickt an',
'L_EMPTY' => 'Leere',
'L_EMPTYKEYS' => 'leeren und Indizes zurücksetzen',
'L_EMPTYTABLEBEFORE' => 'Tabelle vorher leeren',
'L_EMPTY_DB_BEFORE_RESTORE' => 'Datenbank vor Wiederherstellung löschen',
'L_ENCODING' => 'Kodierung',
'L_ENCRYPTION_TYPE' => 'Verschlüsselungsart',
'L_ENGINE' => 'Treiber',
'L_ENTER_DB_INFO' => 'Klicken Sie zuerst auf den Button "zu MySQL verbinden". Nur wenn daraufhin keine Datenbank erkannt werden konnte, ist hier eine Angabe notwendig.',
'L_ENTRY' => 'Eintrag',
'L_ERROR' => 'Fehler',
'L_ERRORHANDLING_RESTORE' => 'Fehlerbehandlung bei Wiederherstellung',
'L_ERROR_CONFIGFILE_NAME' => 'Der Dateiname "%s" enthält ungültige Zeichen.',
'L_ERROR_DELETING_CONFIGFILE' => 'Fehler: die Konfigurationsdatei %s konnte nicht gelöscht werden!',
'L_ERROR_LOADING_CONFIGFILE' => 'Die Konfigurationsdatei "%s" konnte nicht geladen werden.',
'L_ERROR_LOG' => 'Error-Log',
'L_ERROR_MULTIPART_RESTORE' => 'Multipart-Wiederherstellung: Konnte die nächste Datei \'%s\' nicht finden!',
...
'L_FATAL_ERROR_DUMP' => 'Schwerwiegender Fehler: die CREATE-Anweisung der Tabelle \'%s\' in der Datenbank \'%s\' konnte nicht gelesen werden!',
'L_FIELDS' => 'Felder',
...
'L_FILE_OPEN_ERROR' => 'Fehler: Die Datei konnte nicht geöffnet werden.',
'L_FILE_SAVED_SUCCESSFULLY' => 'Die Datei wurde erfolgreich gespeichert.',
'L_FILE_SAVED_UNSUCCESSFULLY' => 'Die Datei konnte nicht gespeichert werden!',
'L_FILE_UPLOAD_SUCCESSFULL' => 'Die Datei \'%s\' wurde erfolgreich hochgeladen.',
...
'L_FM_ASKDELETE3' => 'Möchten Sie das automatische Löschen nach den eingestellten Regeln jetzt ausführen?',
'L_FM_ASKDELETE4' => 'Möchten Sie alle Backup-Dateien jetzt löschen?',
'L_FM_ASKDELETE5' => 'Möchten Sie alle Backup-Dateien mit',
'L_FM_ASKDELETE5_2' => '* jetzt löschen?',
'L_FM_AUTODEL1' => 'Automatisches Löschen: Folgende Dateien wurden aufgrund der maximalen Dateianzahl gelöscht:',
...
'L_FM_DELETEAUTO' => 'Automatisches löschen manuell ausführen',
...
'L_FM_RESTORE_HEADER' => 'Wiederherstellung der Datenbank `<strong>%s</strong>`',
...
'L_FM_UPLOADFILEEXISTS' => 'Es existiert bereits eine Datei mit diesem Namen!',
'L_FM_UPLOADFILEREQUEST' => 'Geben Sie bitte eine Datei an.',
'L_FM_UPLOADMOVEERROR' => 'Die hochgeladene Datei konnte nicht in den richtigen Ordner verschoben werden.',
'L_FM_UPLOADNOTALLOWED1' => 'Dieser Dateityp ist nicht erlaubt.',
'L_FM_UPLOADNOTALLOWED2' => 'Gültige Typen sind: *.gz und *.sql-Dateien',
...
'L_FTP_CONFIRM_DELETE' => 'Soll diese FTP-Verbindung wirklich gelöscht werden?',
...
'L_FTP_CONNECTION_ERROR' => 'Die Verbindung zum Server \'%s\' über Port %s konnte nicht aufgebaut werden',
'L_FTP_CONNECTION_SUCCESS' => 'Die Verbindung zum Server \'%s\' über Port %s wurde erfolgreich hergestellt',
'L_FTP_DIR' => 'Upload-Ordner',
'L_FTP_FILE_TRANSFER_ERROR' => 'Die Übertragung der Datei \'%s\' war fehlerhaft',
'L_FTP_FILE_TRANSFER_SUCCESS' => 'Die Datei \'%s\' wurde erfolgreich übertragen',
'L_FTP_LOGIN_ERROR' => 'Die Anmeldung als Benutzer \'%s\' wurde abgelehnt',
'L_FTP_LOGIN_SUCCESS' => 'Die Anmeldung als Benutzer \'%s\' war erfolgreich',
'L_FTP_OK' => 'Die Verbindung wurde erfolgreich hergestellt.',
'L_FTP_PASS' => 'Passwort',
'L_FTP_PASSIVE' => 'passiven Übertragungsmodus benutzen',
'L_FTP_PASV_ERROR' => 'Der Wechsel in den passiven FTP-Modus war nicht erfolgreich',
'L_FTP_PASV_SUCCESS' => 'Der Wechsel in den passiven FTP-Modus war erfolgreich',
'L_FTP_PORT' => 'Port',
...
'L_HTACC_CONFIRM_DELETE' => 'Soll der Verzeichnisschutz jetzt erstellt werden?',
...
'L_HTACC_CREATE_ERROR' => 'Es ist ein Fehler bei der Erstellung des Verzeichnisschutzes aufgetreten!<br />Bitte erzeugen Sie die Dateien manuell mit folgendem Inhalt',
'L_HTACC_CRYPT' => 'Crypt maximal 8 Zeichen (Linux und Unix-Systeme)',
...
'L_HTACC_EXISTS' => 'Es besteht bereits ein Verzeichnisschutz. Wenn Sie einen neuen erstellen, wird der alte überschrieben!',
...
'L_INSTALL_DB_DEFAULT' => 'Als Standarddatenbank festlegen',
...
'L_LOG' => 'Log',
'L_LOGFILENOTWRITABLE' => 'Log-Datei kann nicht geschrieben werden!',
'L_LOGFILES' => 'Log-Dateien',
'L_LOGGED_IN' => 'Angemeldet',
'L_LOGIN' => 'Anmelden',
'L_LOGIN_AUTOLOGIN' => 'Automatisch anmelden',
'L_LOGIN_INVALID_USER' => 'Diese Kombination von Benutzername und Passwort ist unbekannt.',
'L_LOGOUT' => 'Abmelden',
'L_LOG_CREATED' => 'Logdatei angelegt.',
'L_LOG_DELETE' => 'Log löschen',
'L_LOG_MAXSIZE' => 'Maximale Größe der Logdateien',
'L_LOG_NOT_READABLE' => 'Die Log-Datei \'%s\' existiert nicht oder ist nicht lesbar.',
'L_MAILERROR' => 'Leider ist beim Verschicken der E-Mail ein Fehler aufgetreten!',
'L_MAILPROGRAM' => 'Mailprogramm',
'L_MAXIMUM_LENGTH' => 'Maximallänge',
'L_MAXIMUM_LENGTH_EXPLAIN' => 'Dies ist die Anzahl von Bytes, die ein Zeichen beim Speichern in diesem Zeichensatz maximal verbraucht.',
...
'L_MAX_UPLOAD_SIZE_INFO' => 'Wenn Ihre Backup-Datei größer als das angegebene Limit ist, dann müssen Sie diese per FTP in den "work/backup"-Ordner hochladen. <br />Danach wird diese Datei hier in der Verwaltung angezeigt und lässt sich für eine Wiederherstellung auswählen.',
'L_MEMORY' => 'Speicher',
'L_MENU_HIDE' => 'Menü ausblenden',
'L_MENU_SHOW' => 'Menü einblenden',
'L_MESSAGE' => 'Nachricht',
...
'L_MULTIDUMP_FINISHED' => 'Es wurden <b>%d</b> Datenbanken gesichert',
...
'L_MYSQL_ROUTINES_EXPLAIN' => 'Gespeicherte Funktionen und Prozeduren',
'L_MYSQL_TABLES_EXPLAIN' => 'Tabellen besitzen eine definierte Spaltenstruktur in der Datensätze gespeichert werden können. Jeder Datensatz entspricht dabei einer Zeile der Tabelle.',
...
'L_MYSQL_VIEW' => 'Sicht',
'L_MYSQL_VIEWS' => 'Sichten',
'L_MYSQL_VIEWS_EXPLAIN' => 'Sichten (Views) zeigen (gefilterte) Ansichten auf Datensätze einer oder mehrerer Tabellen. Sie selbst enthalten keine Datensätze.',
'L_NAME' => 'Name',
'L_NEW' => 'neu',
'L_NEWTABLE' => 'Neue Tabelle anlegen',
'L_NEXT_AUTO_INCREMENT' => 'Nächster automatisch vergebener Index',
'L_NEXT_AUTO_INCREMENT_SHORT' => 'Autoindex',
'L_NO' => 'nein',
'L_NOFTPPOSSIBLE' => 'Es stehen keine FTP-Funktionen zur Verfügung!',
'L_NOGZPOSSIBLE' => 'Da zlib nicht installiert ist, stehen keine GZip-Funktionen zur Verfügung!',
'L_NONE' => 'keine',
'L_NOREVERSE' => 'Ältester Eintrag zuerst',
'L_NOTAVAIL' => '<em>nicht verfügbar</em>',
'L_NOTHING_TO_DO' => 'Es gibt nichts zu tun.',
'L_NOTICE' => 'Hinweis',
'L_NOTICES' => 'Hinweise',
'L_NOT_ACTIVATED' => 'nicht aktiviert',
'L_NOT_SUPPORTED' => 'Dieses Backup unterstützt diese Funktion nicht.',
'L_NO_DB_FOUND' => 'Es wurde keine Datenbank gefunden.<br />Blenden Sie die Verbindungsparameter ein und geben Sie den Namen Ihrer Datenbanken manuell ein!',
'L_NO_DB_FOUND_INFO' => 'Die Verbindung zur Datenbank konnte erfolgreich hergestellt werden.<br /><br />Ihre Zugangsdaten sind gültig und wurden vom MySQL-Server akzeptiert.<br /><br />Leider konnte MySQLDumper keine Datenbank finden.<br /><br />Die automatische Erkennung per Programm ist bei manchen Hostern gesperrt.<br /><br />Sie müssen Ihre Datenbank nach dem Abschluß der Installation unter dem Menüpunkt "Konfiguration" "Verbindungsparameter einblenden" angeben.<br /><br />Bitte begeben Sie sich nach Abschluß der Installation umgehend dort hin und tragen den Namen Ihrer Datenbank dort ein.',
'L_NO_DB_SELECTED' => 'Es ist keine Datenbank gewählt.',
'L_NO_ENTRIES' => 'Die Tabelle ist leer und enthält keine Einträge.',
'L_NO_MSD_BACKUPFILE' => 'Dateien anderer Programme',
'L_NO_NAME_GIVEN' => 'Sie haben keinen Namen angegeben.',
'L_NR_OF_QUERIES' => 'Anzahl Querys',
'L_NR_OF_RECORDS' => 'Anzahl der Datensätze',
'L_NR_TABLES_OPTIMIZED' => '%s Tabellen wurden optimiert.',
'L_NUMBER_OF_FILES_FORM' => 'Anzahl von Backup-Dateien pro Datenbank',
'L_OF' => 'von',
'L_OK' => 'OK',
'L_OPTIMIZE' => 'Optimiere',
'L_OPTIMIZE_TABLES' => 'Tabellen vor dem Backup optimieren',
'L_OPTIMIZE_TABLE_ERR' => 'Fehler beim Optimieren der Tabelle `%s`.',
'L_OPTIMIZE_TABLE_SUCC' => 'Die Tabelle `%s` wurde erfolgreich optimiert.',
'L_OS' => 'Betriebssystem',
'L_OVERHEAD' => 'Überhang',
'L_PAGE' => 'Seite',
...
'L_PASS' => 'Passwort',
'L_PASSWORD' => 'Kennwort',
'L_PASSWORDS_UNEQUAL' => 'Die Passwörter sind nicht identisch oder leer!',
'L_PASSWORD_REPEAT' => 'Kennwort (Wiederholung)',
'L_PASSWORD_STRENGTH' => 'Kennwortstärke',
'L_PERLOUTPUT1' => 'Eintrag in crondump.pl für absolute_path_of_configdir',
'L_PERLOUTPUT2' => 'Aufruf im Browser oder für externen Cronjob',
'L_PERLOUTPUT3' => 'Aufruf in der Shell oder für die Crontab',
'L_PERL_COMPLETELOG' => 'Perl-Complete-Log',
'L_PERL_LOG' => 'Perl-Log',
'L_PHPBUG' => 'Bug in zlib! Keine Kompression möglich!',
...
'L_POSSIBLE_COLLATIONS' => 'Mögliche Sortierungen',
'L_POSSIBLE_COLLATIONS_EXPLAIN' => 'Dies sind die für diesen Zeichensatz möglichen Sortierregeln.<br /><br />_cs = case sensitiv -> Groß-/Kleinschreibung wird unterschieden<br />_ci = case insensitive -> Groß-/Kleinschreibung wird nicht beachtet',
'L_PREFIX' => 'Präfix',
'L_PRIMARYKEYS_CHANGED' => 'Primärschlüssel geändert',
'L_PRIMARYKEYS_CHANGINGERROR' => 'Fehler beim Ändern der Primärschlüssel',
...
'L_RECORDS_INSERTED' => '<b>%s</b> Datensätze wurden eingetragen.',
'L_RECORDS_OF_TABLE' => 'Datensätze der Tabelle',
'L_RECORDS_PER_PAGECALL' => 'Datensätze pro Seitenaufruf',
'L_REFRESHTIME' => 'Aktualisierungsintervall',
'L_REFRESHTIME_PROCESSLIST' => 'Aktualisierungsintervall der Prozessliste',
...
'L_RESTORE_DB' => 'Datenbank \'<b>%s</b>\' auf Server \'<b>%s</b>\'.',
'L_RESTORE_DB_COMPLETE_IN' => 'Wiederherstellung der Datenbank \'%s\' in %s abgeschlossen.',
'L_RESTORE_OF_TABLES' => 'Wiederherstellen bestimmter Tabellen',
'L_RESTORE_TABLE' => 'Wiederherstellung der Tabelle \'%s\'',
'L_RESTORE_TABLES_COMPLETED' => 'Es wurden bisher <b>%d</b> von <b>%d</b> Tabellen angelegt.',
'L_RESTORE_TABLES_COMPLETED0' => 'Es wurden bisher <b>%d</b> Tabellen angelegt.',
'L_RESULT' => 'Ergebnis',
'L_REVERSE' => 'Neuster Eintrag zuerst',
'L_SAFEMODEDESC' => 'Da PHP auf diesem Server mit der Option "safe_mode=on" ausgeführt wird, müssen folgende Verzeichnisse von Hand angelegt werden (dies können Sie mit Ihrem FTP-Programm erledigen):<br /><br /><br />',
'L_SAVE' => 'Speichern',
'L_SAVEANDCONTINUE' => 'speichern und Installation fortsetzen',
'L_SAVE_ERROR' => 'Die Einstellungen konnten nicht gespeichert werden!',
'L_SAVE_SUCCESS' => 'Die Einstellungen wurden erfolgreich in der Konfigurationsdatei "%s" gespeichert.',
'L_SAVING_DATA_TO_FILE' => 'Speichere Daten der Datenbank \'%s\' in der Datei \'%s\'',
'L_SAVING_DATA_TO_MULTIPART_FILE' => 'Maximale Dateigröße erreicht: Fortfahren mit Datei \'%s\'',
...
'L_SEARCH_NO_RESULTS' => 'Die Suche nach "<b>%s</b>" in der Tabelle "<b>%s</b>" liefert keine Ergebnisse!',
'L_SEARCH_OPTIONS' => 'Suchoptionen',
'L_SEARCH_OPTIONS_AND' => 'eine Spalte muss alle Suchbegriffe enthalten (UND-Suche)',
'L_SEARCH_OPTIONS_CONCAT' => 'ein Datensatz muss alle Suchbegriffe enthalten, diese können aber in beliebigen Spalten sein (Rechenintensiv!)',
'L_SEARCH_OPTIONS_OR' => 'eine Spalte muss mindestens einen Suchbegriff enthalten (ODER-Suche)',
'L_SEARCH_RESULTS' => 'Die Suche nach "<b>%s</b>" in der Tabelle "<b>%s</b>" lieferte folgende Treffer',
'L_SECOND' => 'Sekunde',
'L_SECONDS' => 'Sekunden',
'L_SELECT' => 'Wählen',
'L_SELECTED_FILE' => 'Gewählte Datei',
'L_SELECT_ALL' => 'Alle auswählen',
...
'L_SETPRIMARYKEYSFOR' => 'Setzen neuer Primärschlüssel für die Tabelle',
'L_SHOWING_ENTRY_X_TO_Y_OF_Z' => 'Zeige Eintrag %s bis %s von %s',
'L_SHOWRESULT' => 'Ergebnis anzeigen',
'L_SHOW_TABLES' => 'Tabellen anzeigen',
'L_SHOW_TOOLTIPS' => 'Schönere Tooltips anzeigen',
'L_SMTP' => 'SMTP',
...
'L_SQL_COLLATENOTMATCH' => 'Zeichensatz und Sortierung passen nicht zueinander!',
...
'L_SQL_DBCOPY' => 'Der Inhalt der Datenbank `%s` wurde in die Datenbank `%s` kopiert.',
'L_SQL_DBSCOPY' => 'Die Struktur der Datenbank `%s` wurde in die Datenbank `%s` kopiert.',
...
'L_SQL_INCOMPLETE_STATEMENT_DETECTED' => '%s: unvollständige Anweisung gefunden.<br />Konnte schließende Übereinstimmung \'%s\' nicht finden. <br />Query:<br />%s',
...
'L_SQL_NOFIELDDELETE' => 'Löschen nicht möglich, da eine Tabelle mindestens 1 Feld haben muss.',
'L_SQL_NOTABLESINDB' => 'Es befinden sich keine Tabellen in der Datenbank',
...
'L_SQL_OUT5' => 'Da die Ausgabe über 5000 Zeilen enthält, wird sie nicht angezeigt.',
...
'L_SQL_SCOPY' => 'Tabellenstruktur von `%s` wurde in Tabelle `%s` kopiert.',
'L_SQL_SEARCH' => 'Suche',
...
'L_SQL_TABLEEMPTIEDKEYS' => 'Tabelle `%s` wurde geleert, und die Indizes wurden zurückgesetzt.',
...
'L_SQL_TCOPY' => 'Tabelle `%s` wurde mit Daten in Tabelle `%s` kopiert.',
...
'L_SQL_WARNING' => 'Die Ausführung von SQL-Befehlen kann Daten manipulieren! Der Autor übernimmt keine Haftung bei Datenverlusten.',
'L_SQL_WASCREATED' => 'wurde erzeugt',
'L_SQL_WASEMPTIED' => 'wurde geleert',
'L_STARTDUMP' => 'Backup starten',
'L_START_RESTORE_DB_FILE' => 'Beginne Wiederherstellung der Datenbank \'%s\' aus Datei \'%s\'.',
'L_START_SQL_SEARCH' => 'Suche starten',
'L_STATUS' => 'Status',
'L_STEP' => 'Schritt',
'L_SUCCESS_CONFIGFILE_CREATED' => 'Die Konfigurationsdatei "%s" wurde erfolgreich angelegt.',
'L_SUCCESS_DELETING_CONFIGFILE' => 'Die Konfigurationsdatei "%s" wurde erfolgreich gelöscht.',
'L_SUM_TOTAL' => 'Summe',
'L_TABLE' => 'Tabelle',
'L_TABLENAME' => 'Tabellenname',
'L_TABLENAME_EXPLAIN' => 'Name der Tabelle',
'L_TABLES' => 'Tabellen',
'L_TABLESELECTION' => 'Tabellenauswahl',
'L_TABLE_CREATE_SUCC' => 'Die Tabelle \'%s\' wurde erfolgreich angelegt.',
'L_TABLE_TYPE' => 'Tabellentyp',
...
'L_TO' => 'bis',
'L_TOOLS' => 'Tools',
'L_TOOLS_TOOLBOX' => 'Datenbank auswählen / Datenbankfunktionen / Im- und Export',
'L_TRUNCATE' => 'Leeren',
'L_TRUNCATE_DATABASE' => 'Datenbank leeren',
'L_UNIT_KB' => 'KiloByte',
'L_UNIT_MB' => 'MegaByte',
'L_UNIT_PIXEL' => 'Pixel',
'L_UNKNOWN' => 'unbekannt',
...
'L_UPDATE_CONNECTION_FAILED' => 'Aktualisierung fehlgeschlagen, da keine Verbindung zum Server \'%s\' aufgebaut werden konnte.',
'L_UPDATE_ERROR_RESPONSE' => 'Aktualisierung fehlgeschlagen, Server antwortete: \'%s\'',
'L_UPTO' => 'bis',
...
'L_WRONGCONNECTIONPARS' => 'Falsche oder keine Verbindungsparameter!',
'L_WRONG_CONNECTIONPARS' => 'Verbindungsparameter stimmen nicht!',
'L_WRONG_RIGHTS' => 'Die Datei oder das Verzeichnis \'%s\' ist für mich nicht beschreibbar. Der Besitzer (Owner) oder die Rechte (Chmod) sind falsch gesetzt.<br /><br />Setzen Sie die richtigen Attribute mit Ihrem FTP-Programm. Die Datei oder das Verzeichnis benötigt die Rechte %s.',
'L_YES' => 'ja',
'L_ZEND_FRAMEWORK_VERSION' => 'Zend Framework Version',
'L_ZEND_ID_ACCESS_NOT_A_DIRECTORY' => 'Der angegebene Dateiname \'%value%\' ist kein Verzeichnis.',
...
'L_ZEND_ID_ACCESS_NOT_EXISTS' => 'Die Datei oder das Verzeichnis \'%value%\' existiert nicht.',
'L_ZEND_ID_ACCESS_NOT_READABLE' => 'Die Datei oder das Verzeichnis \'%value%\' ist nicht lesbar.',
'L_ZEND_ID_ACCESS_NOT_UPLOADED' => 'Die angegebene Datei \'%value%\' wurde nicht hoch geladen.',
'L_ZEND_ID_ACCESS_NOT_WRITABLE' => 'Die Datei oder das Verzeichnis \'%value%\' ist nicht schreibbar.',
'L_ZEND_ID_DIGITS_INVALID' => 'Ungültigen Typ übergeben. Erwartet wird String, Integer oder Float.',
'L_ZEND_ID_DIGITS_STRING_EMPTY' => 'Der Wert ist leer.',
'L_ZEND_ID_EMAIL_ADDRESS_DOT_ATOM' => 'Die E-Mail-Adresse kann nicht gegen das "Dot-Atom"-Format geprüft werden.',
'L_ZEND_ID_EMAIL_ADDRESS_INVALID' => 'Ungültiger Typ übergeben. Erwartet wird String.',
'L_ZEND_ID_EMAIL_ADDRESS_INVALID_FORMAT' => 'Das Format der E-Mail-Adresse ist ungültig.',
'L_ZEND_ID_EMAIL_ADDRESS_INVALID_HOSTNAME' => 'Der Domainname ist ungültig.',
'L_ZEND_ID_EMAIL_ADDRESS_INVALID_LOCAL_PART' => 'Der lokale Teil der E-Mail-Adresse (Lokaler-Teil@Domain.TLD) ist ungültig.',
'L_ZEND_ID_EMAIL_ADDRESS_INVALID_MX_RECORD' => 'Für die E-Mail-Adresse gibt es keinen gültigen MX-Eintrag.',
'L_ZEND_ID_EMAIL_ADDRESS_INVALID_SEGMENT' => 'Die Domain befindet sich in einem nicht routbaren Netzwerksegment. Die E-Mail-Adresse kann vom öffentlichen Netzwerk nicht aufgelöst werden.',
'L_ZEND_ID_EMAIL_ADDRESS_LENGTH_EXCEEDED' => 'Die E-Mail-Adresse ist zu lang. Sie darf maximal 320 Zeichen lang sein.',
'L_ZEND_ID_EMAIL_ADDRESS_QUOTED_STRING' => 'Die E-Mail-Adresse kann nicht gegen das "Quoted-String"-Format geprüft werden.',
'L_ZEND_ID_HOSTNAME_CANNOT_DECODE_PUNYCODE' => 'Die angegebene Punycode-Schreibweise des Domainnamen kann nicht dekodiert werden.',
'L_ZEND_ID_HOSTNAME_DASH_CHARACTER' => 'Der Domainname enthält einen Bindestrich an einer ungültigen Position.',
'L_ZEND_ID_HOSTNAME_INVALID' => 'Ungültiger Typ übergeben. Erwartet wird String.',
'L_ZEND_ID_HOSTNAME_INVALID_HOSTNAME' => 'Der Domainname entspricht nicht der erwarteten Struktur.',
'L_ZEND_ID_HOSTNAME_INVALID_HOSTNAME_SCHEMA' => 'Der Domainname entspricht nicht dem Schema der angegebenen TLD.',
'L_ZEND_ID_HOSTNAME_INVALID_LOCAL_NAME' => 'Der Domainname beinhaltet einen ungültigen lokalen Netzwerknamen.',
'L_ZEND_ID_HOSTNAME_INVALID_URI' => 'Der Domainname entspricht nicht der URI-Syntax.',
'L_ZEND_ID_HOSTNAME_IP_ADDRESS_NOT_ALLOWED' => 'IP-Adressen in Dommainnamen sind nicht erlaubt.',
'L_ZEND_ID_HOSTNAME_LOCAL_NAME_NOT_ALLOWED' => 'Lokale Netzwerknamen in Domainnamen sind nicht erlaubt.',
'L_ZEND_ID_HOSTNAME_UNDECIPHERABLE_TLD' => 'Die TLD kann nicht aus dem Domainnamen extrahiert werden.',
'L_ZEND_ID_HOSTNAME_UNKNOWN_TLD' => 'Der Domainname enthält unbekannte TLD.',
'L_ZEND_ID_IS_EMPTY' => 'Der Wert wird benötigt und darf nicht leer sein.',
'L_ZEND_ID_MISSING_TOKEN' => 'Es wurde kein Merkmal zum Gegenprüfen angegeben.',
