...
$lang['L_ACTUALLY_INSERTED_RECORDS']="Hasta el momento, se han recuperado"<br />    ." <b>%s</b> de tablas.";
$lang['L_ACTUALLY_INSERTED_RECORDS_OF']="Hasta ahora se han importado <b>%s</b>"<br />    ." de <b>%s</b> registros.";
$lang['L_ADD']="Añadir";
...
$lang['L_ANALYZING_TABLE']="Se está llenando de datos la tabla"<br />    ." '<b>%s</b>'.";
$lang['L_ASKDBCOPY']="¿Desea copiar el contenido de la base"<br />    ." de datos `%s` a la base de datos `%s`?";
$lang['L_ASKDBDELETE']="¿Desea realmente eliminar la base de"<br />    ." datos `%s` así como todos sus"<br />    ." contenidos?";
$lang['L_ASKDBEMPTY']="¿Desea realmente vaciar la base de"<br />    ." datos `%s` ?";
...
$lang['L_ASKTABLEEMPTYKEYS']="¿Desea vaciar la tabla `%s` y"<br />    ." resetear sus índices?";
...
$lang['L_AUTODELETE']="Eliminación automática de las copias"<br />    ." de seguridad";
$lang['L_BACK']="atrás";
$lang['L_BACKUPFILESANZAHL']="En el directorio de copias de"<br />    ." seguridad se encuentran";
$lang['L_BACKUPS']="copias de seguridad";
$lang['L_BACKUP_DBS']="BB.DD. a copiar";
$lang['L_BACKUP_TABLE_DONE']="Seguridad de la tabla `%s` completado."<br />    ." %s registros fueron almacenados.";
...
$lang['L_CONFIG_CRONPERL']="Propiedades de Crondump como script"<br />    ." perl";
$lang['L_CONFIG_EMAIL']="Notificación por correo electrónico";
$lang['L_CONFIG_FTP']="Transferencia por FTP de las copias de"<br />    ." seguridad";
...
$lang['L_CONFIRM_RECIPIENT_DELETE']="El destinatario \"%s\" debería ser"<br />    ." borrado?";
...
$lang['L_CONTINUE_MULTIPART_RESTORE']="Continuar recuperació multiplo por el"<br />    ." siguiente archivo '%s'.";
...
$lang['L_CONVERT_FILENAME']="Nombre del archivo de destino (sin"<br />    ." extensión)";
$lang['L_CONVERT_FILEREAD']="Leyendo el archivo '%s'";
$lang['L_CONVERT_FINISHED']="Conversión finalizada: '%s' se ha"<br />    ." guardado correctamente.";
$lang['L_CONVERT_START']="Iniciar conversión";
$lang['L_CONVERT_TITLE']="Convertir copia de seguridad al"<br />    ." formato MSD";
$lang['L_CONVERT_WRONG_PARAMETERS']="¡Parámetros incorrectos!  La"<br />    ." conversión no es posible.";
$lang['L_CREATE']="crear";
$lang['L_CREATED']="Creado";
$lang['L_CREATEDIRS']="Directorios creados";
$lang['L_CREATE_AUTOINDEX']="Crear índice automático";
$lang['L_CREATE_CONFIGFILE']="Crear un nuevo archivo de"<br />    ." configuración";
$lang['L_CREATE_DATABASE']="Crear nueva base de datos";
$lang['L_CREATE_TABLE_SAVED']="Definición de la tabla `% s"<br />    ." 'guardado.";
...
$lang['L_CSV_FIELDCOUNT_NOMATCH']="El número de campos no coincide con"<br />    ." el de los datos a importar (%d en vez"<br />    ." de  %d).";
...
$lang['L_CSV_FIELDSLINES']="%d campos reconocidos, totalizando %d"<br />    ." líneas";
$lang['L_CSV_FILEOPEN']="abrir fichero CSV";
$lang['L_CSV_NAMEFIRSTLINE']="Nombres de campo en la primera línea";
$lang['L_CSV_NODATA']="¡No se han encontrado datos que"<br />    ." importar!";
...
$lang['L_DATASIZE_INFO']="Este es el tamaño de los datos"<br />    ." contenidos en la base de datos, no el"<br />    ." tamaño del file de backup.";
$lang['L_DAY']="Día";
$lang['L_DAYS']="Días";
...
$lang['L_DB_BACKUPPARS']="Propiedades de la copia de seguridad"<br />    ." de la base de datos";
$lang['L_DB_DEFAULT']="Default database";
$lang['L_DB_HOST']="Servidor de base de datos";
$lang['L_DB_IN_LIST']="La base de datos '%s' no se podría"<br />    ." añadir porque ya existe.";
$lang['L_DB_NAME']="Nombre de la base de datos";
$lang['L_DB_PASS']="Contraseña";
$lang['L_DB_SELECT_ERROR']="<br />Error:<br />La selección de la"<br />    ." base de datos '<b>";
...
$lang['L_DELETE_FILE_ERROR']="¡No fue posible borrar el archivo"<br />    ." \"%s\"!";
$lang['L_DELETE_FILE_SUCCESS']="El archivo \"%s\" se ha eliminado con"<br />    ." éxito.";
$lang['L_DELETE_HTACCESS']="Quitar la protección de directorio"<br />    ." (eliminar .htaccess)";
...
$lang['L_DUMP_ENDERGEBNIS']="<b>%s</b> Tablas con un total de"<br />    ." <b>%s</b> registros, han sido"<br />    ." guardadas con éxito.<br />";
$lang['L_DUMP_FILENAME']="Archivo de backup";
$lang['L_DUMP_HEADLINE']="Creando copia de seguridad...";
$lang['L_DUMP_NOTABLES']="No se han encontrado tablas en la base"<br />    ." de datos `%s`";
...
$lang['L_EMAILBODY_FOOTER']="<br /><br /><br />Saludos de<br /><br"<br />    ." />MySQLDumper<br />";
...
$lang['L_EMPTY_DB_BEFORE_RESTORE']="Vaciar la base de datos antes de"<br />    ." recuperar los valores";
...
$lang['L_ERROR']="Error";
$lang['L_ERRORHANDLING_RESTORE']="Tratamiento de los errores en la"<br />    ." recuperación de datos";
$lang['L_ERROR_CONFIGFILE_NAME']="El nombre del archivo \"%s\" contiene"<br />    ." caracteres no válidos.";
$lang['L_ERROR_DELETING_CONFIGFILE']="¡Error: el archivo de configuración"<br />    ." %s no ha podido ser eliminado!";
$lang['L_ERROR_LOADING_CONFIGFILE']="No se pudo cargar el archivo de"<br />    ." configuración \"%s\".";
$lang['L_ERROR_LOG']="Archivo de registro de errores";
$lang['L_ERROR_MULTIPART_RESTORE']="Restablecimiento múltiple: No se"<br />    ." puede encontrar el siguiente archivo"<br />    ." '%s'!";
...
$lang['L_FATAL_ERROR_DUMP']="¡Error fatal: las instrucciones para"<br />    ." crear la tabla '%s' en la base de"<br />    ." datos '%s' no se pueden leer!";
...
$lang['L_FILE_SAVED_SUCCESSFULLY']="El archivo se ha guardado"<br />    ." correctamente.";
$lang['L_FILE_SAVED_UNSUCCESSFULLY']="El archivo no puede ser salvado!";
$lang['L_FILE_UPLOAD_SUCCESSFULL']="El archivo '%s' se subido"<br />    ." correctamente.";
...
$lang['L_FM_ASKDELETE3']="¿Desea ejecutar el borrado"<br />    ." automático según las reglas"<br />    ." especificadas?";
$lang['L_FM_ASKDELETE4']="¿Desea eliminar todos los archivos de"<br />    ." copia de seguridad?";
$lang['L_FM_ASKDELETE5']="¿Desea eliminar todos los archivos"<br />    ." con el prefijo";
...
$lang['L_FM_DELETEAUTO']="Ejecutar borrado automático"<br />    ." manualmente";
...
$lang['L_FM_RESTORE_HEADER']="Recuperación de la base de datos"<br />    ." `<strong>%s</strong>`";
...
$lang['L_FM_UPLOADFILEEXISTS']="¡ Ya existe un archivo con este"<br />    ." nombre !";
$lang['L_FM_UPLOADFILEREQUEST']="Por favor, elija un archivo.";
$lang['L_FM_UPLOADMOVEERROR']="No se ha podido copiar el archivo"<br />    ." enviado al directorio correcto.";
$lang['L_FM_UPLOADNOTALLOWED1']="Esta clase de archivo no está"<br />    ." permitida.";
$lang['L_FM_UPLOADNOTALLOWED2']="Los tipos de archivo permitidos son:"<br />    ." *.gz y *.sql";
...
$lang['L_FTP_CONFIRM_DELETE']="Desea que esta conexión FTP séa"<br />    ." realmente eliminado?";
...
$lang['L_FTP_CONNECTION_ERROR']="Conexión con el servidor '%s', usando"<br />    ." el puerto %s, no se pudo evaluar";
$lang['L_FTP_CONNECTION_SUCCESS']="Conexión con el servidor '%s', usando"<br />    ." el puerto %s se ha establecido con"<br />    ." éxito";
$lang['L_FTP_DIR']="Directorio de subida";
$lang['L_FTP_FILE_TRANSFER_ERROR']="Mal manejo de el file '%s'";
$lang['L_FTP_FILE_TRANSFER_SUCCESS']="El file '%s' fue transferido con"<br />    ." éxito";
$lang['L_FTP_LOGIN_ERROR']="Ha denegado el acceso del usuario '%s'";
$lang['L_FTP_LOGIN_SUCCESS']="Consultado el usuario '%s'";
$lang['L_FTP_OK']="La conexión se ha realizado"<br />    ." correctamente";
...
$lang['L_FTP_PASV_SUCCESS']="El cambio a modo pasivo, fue un"<br />    ." éxito!";
$lang['L_FTP_PORT']="Puerto";
$lang['L_FTP_SEND_TO']="para <strong>%s</strong><br />en"<br />    ." <strong>%s</s>";
...
$lang['L_HTACC_CONFIRM_DELETE']="¿Desea crear ahora la protección del"<br />    ." directorio?";
...
$lang['L_HTACC_EXISTS']="Ya existe actualmente una protección"<br />    ." del directorio. ¡Si crea una nueva,"<br />    ." la antigua será sobreescrita!";
...
$lang['L_IMPORT_NOTABLE']="¡No ha seleccionado ninguna tabla"<br />    ." para importar!";
$lang['L_IN']="en";
$lang['L_INDEX_SIZE']="Size of index";
$lang['L_INFO_ACTDB']="Base de datos actual";
$lang['L_INFO_DATABASES']="Las siguentes bases de datos se"<br />    ." encuentran en el servidor de MySQL";
...
$lang['L_LOGFILENOTWRITABLE']="No se puede escribir en el archivo de"<br />    ." registro (log)!";
...
$lang['L_LOGIN_INVALID_USER']="La dirección de correo electrónico o"<br />    ." la contraseña son incorrectas.";
...
$lang['L_LOG_NOT_READABLE']="El archivo de registro '%s' no existe"<br />    ." o no es legible.";
$lang['L_MAILERROR']="Se ha producido un error al intentar"<br />    ." enviar el email!";
...
$lang['L_MULTIDUMP_FINISHED']="Copia de seguridad de <b>%d</b> bases"<br />    ." de datos resalizada";
$lang['L_MULTIPART_ACTUAL_PART']="Sub archivo actual";
$lang['L_MULTIPART_SIZE']="Tamaño máximo del archivo";
$lang['L_MULTI_PART']="Copia de seguridad en múltiples"<br />    ." archivos";
$lang['L_MYSQLVARS']="Variables de MySQL";
$lang['L_MYSQL_CLIENT_VERSION']="Cliente MySQL";
$lang['L_MYSQL_CONNECTION_ENCODING']="Codificación por defecto para"<br />    ." MySQL-Server";
...
$lang['L_NO']="no";
$lang['L_NOFTPPOSSIBLE']="Las funciones de FTP no están"<br />    ." disponibles!";
$lang['L_NOGZPOSSIBLE']="Dado que Zlib no está instalado, no"<br />    ." puede usar las funciones de"<br />    ." compresión GZip!";
$lang['L_NONE']="ninguno";
$lang['L_NOREVERSE']="Mostrar las entradas más antiguas"<br />    ." primero";
...
$lang['L_NO_ENTRIES']="La tabla \"<b>%s</b>\" está vacía y"<br />    ." no contiene ninguna entrada.";
...
$lang['L_NUMBER_OF_FILES_FORM']="Cantidad de archivos de copia de"<br />    ." seguridad";
$lang['L_OF']="de";
$lang['L_OK']="Ok";
$lang['L_OPTIMIZE']="Optimizar";
$lang['L_OPTIMIZE_TABLES']="Optimizar las tablas antes de la copia"<br />    ." de seguridad";
$lang['L_OPTIMIZE_TABLE_ERR']="No se ha podido optimizar la tabla"<br />    ." `%s`.";
$lang['L_OPTIMIZE_TABLE_SUCC']="La tabla `%s` ha sido optimizado con"<br />    ." éxito.";
...
$lang['L_PASSWORDS_UNEQUAL']="¡Las contraseñas no son idénticos o"<br />    ." vacíos!";
$lang['L_PASSWORD_REPEAT']="Contraseña (repetición)";
$lang['L_PASSWORD_STRENGTH']="Fortaleza de la contraseña";
$lang['L_PERLOUTPUT1']="Línea a escribir en crondump.pl para"<br />    ." absolute_path_of_configdir";
$lang['L_PERLOUTPUT2']="Ejecutar desde el navegador o desde un"<br />    ." Cronjob externo al servidor";
$lang['L_PERLOUTPUT3']="Ejecutar desde Shell o como entrada en"<br />    ." Crontab";
$lang['L_PERL_COMPLETELOG']="Completo-Perl-Log";
$lang['L_PERL_LOG']="Archivos en Perl";
$lang['L_PHPBUG']="¡Bug en zlib! No es posible comprimir"<br />    ." archivos!";
...
$lang['L_PRIMARYKEY_CONFIRMDELETE']="¿Realmente desea eliminar la clave"<br />    ." principal?";
...
$lang['L_RESTORE_COMPLETE']="<b>%s</b> Las tablas han sido"<br />    ." importadas.";
$lang['L_RESTORE_DB']="la base de datos '<b>%s</b>' en"<br />    ." '<b>%s</b>'.";
$lang['L_RESTORE_DB_COMPLETE_IN']="Restablecimiento de la base de datos"<br />    ." '%s' se ha completado en %s.";
...
$lang['L_SAVE_ERROR']="¡La configuración no ha podido ser"<br />    ." guardada!";
$lang['L_SAVE_SUCCESS']="La configuración se ha guardado con"<br />    ." éxito en el archivo de configuración"<br />    ." \"%s\".";
$lang['L_SAVING_DATA_TO_FILE']="Guardar el contenido de la database"<br />    ." '%s' en el archivo '%s'";
$lang['L_SAVING_DATA_TO_MULTIPART_FILE']="Tamaño máximo alcanzado: Continuar"<br />    ." con el archivo '%s'";
$lang['L_SAVING_DB_FORM']="Base de datos";
$lang['L_SAVING_TABLE']="Guardando tabla";
$lang['L_SEARCH_ACCESS_KEYS']="Navegar:<br />Adelante=ALT+V<br />Atrás=ALT+C";
$lang['L_SEARCH_IN_TABLE']="Buscar en la tabla";
$lang['L_SEARCH_NO_RESULTS']="¡La búsqueda para \"<b>%s</b>\" en"<br />    ." la tabla \"<b>%s</b>\" no produjo"<br />    ." ningún resultado!";
...
$lang['L_SETPRIMARYKEYSFOR']="Establecer nueva clave principal para"<br />    ." la tabla";
...
$lang['L_SQL_COLLATENOTMATCH']="¡Este juego de caracteres y el orden"<br />    ." solicitado no pueden funcionar juntos!";
...
$lang['L_SQL_DBCOPY']="El contenido de la base de datos `%s`"<br />    ." ha sido copiado a la base de datos"<br />    ." `%s`.";
$lang['L_SQL_DBSCOPY']="La estructura de la base de datos `%s`"<br />    ." ha sido copiado a la base de datos"<br />    ." `%s`.";
...
$lang['L_SQL_NODEST_COPY']="¡Sin destino, no se puede copiar"<br />    ." nada!";
$lang['L_SQL_NOFIELDDELETE']="Eliminación imposible, ya que la"<br />    ." tabla debe contener al menos un campo.";
$lang['L_SQL_NOTABLESINDB']="No hay ninguna tabla en la base de"<br />    ." datos";
...
$lang['L_SQL_OUT5']="Dado que el comando afecta más de"<br />    ." 5000 registros, no se mostrarán los"<br />    ." resultados.";
...
$lang['L_SQL_SCOPY']="La estructura de tabla de `%s` ha sido"<br />    ." copiada en la tabla `%s`.";
...
$lang['L_SQL_TABLEEMPTIEDKEYS']="La tabla `%s` ha sido eliminada, y los"<br />    ." índices reinicializados.";
...
$lang['L_SQL_TBLNAMEEMPTY']="¡El nombre de la tabla no puede estar"<br />    ." vacío!";
$lang['L_SQL_TBLPROPSOF']="Propiedades de tabla de";
$lang['L_SQL_TCOPY']="La tabla `%s` ha sido copiada (con sus"<br />    ." datos), en la tabla `%s`.";
...
$lang['L_START_RESTORE_DB_FILE']="Inicie la recuperación de database"<br />    ." '%s' del archivo '%s'.";
$lang['L_START_SQL_SEARCH']="Iniciar búsqueda";
$lang['L_STATUS']="Estado";
$lang['L_STEP']="Paso";
$lang['L_SUCCESS_CONFIGFILE_CREATED']="El archivo de configuración \"%s\" se"<br />    ." ha creado correctamente.";
$lang['L_SUCCESS_DELETING_CONFIGFILE']="El archivo de configuración \"%s\" ha"<br />    ." sido eliminado.";
$lang['L_TABLE']="Tabla";
...
$lang['L_TABLE_CREATE_SUCC']="La tabla '%s' se ha creado"<br />    ." correctamente.";
...
$lang['L_TOOLS_TOOLBOX']="Elección de base de datos / Funciones"<br />    ." de base de datos / Im- y Exportar";
...
$lang['L_UPDATE_CONNECTION_FAILED']="Actualización falló, porque con '%s'"<br />    ." del servidor no se pudo establecer.";
$lang['L_UPDATE_ERROR_RESPONSE']="Actualización falló, el servidor"<br />    ." devuelve: '%s'";
$lang['L_UPTO']="hasta";
...
$lang['L_ZEND_ID_ACCESS_NOT_A_DIRECTORY']="El nombre de archivo dado '%value%' no"<br />    ." es un directorio.";
$lang['L_ZEND_ID_ACCESS_NOT_A_FILE']="El nombre de archivo dado '%value%' no"<br />    ." es un archivo.";
$lang['L_ZEND_ID_ACCESS_NOT_A_LINK']="El objetivo determinado '%value%' no"<br />    ." es un link.";
$lang['L_ZEND_ID_ACCESS_NOT_EXECUTABLE']="El archivo o directorio '%value%' no"<br />    ." es ejecutable.";
$lang['L_ZEND_ID_ACCESS_NOT_EXISTS']="El archivo o directorio '%value%' no"<br />    ." existe.";
$lang['L_ZEND_ID_ACCESS_NOT_READABLE']="El archivo o directorio '%value%' no"<br />    ." es legible.";
$lang['L_ZEND_ID_ACCESS_NOT_UPLOADED']="El archivo dado '%value%' no es un"<br />    ." archivo subido.";
$lang['L_ZEND_ID_ACCESS_NOT_WRITABLE']="El archivo o directorio 'value%%' no"<br />    ." está escribible.";
$lang['L_ZEND_ID_DIGITS_INVALID']="Tipo no válido entregado. Se espera"<br />    ." String, Integer o Float.";
$lang['L_ZEND_ID_DIGITS_STRING_EMPTY']="El valor está vacío.";
$lang['L_ZEND_ID_EMAIL_ADDRESS_DOT_ATOM']="La dirección de correo electrónico"<br />    ." no puede ser comparada al formato"<br />    ." \"dot-atom\".";
$lang['L_ZEND_ID_EMAIL_ADDRESS_INVALID']="Tipo no válido entregado. Se espera"<br />    ." String.";
$lang['L_ZEND_ID_EMAIL_ADDRESS_INVALID_FORMAT']="La dirección de correo electrónico"<br />    ." es incorrecta.";
...
$lang['L_ZEND_ID_NOT_EMPTY_INVALID']="Tipo no válido dado. String, integer,"<br />    ." float, booleanos o array espera.";
