...
Figyelmeztetés: az"
    ." összes adat törölve lesz! Talán"
    ." szeretnél egy biztonsági mentést"
    ." készíteni először.";
...
$lang['L_MYSQL_VERSION_TOO_OLD']="Sajnáljuk, a telepített"
    ...
    ." verzióra.
Alternatívaként"
    ." feltelepítheted a MySQLDumper 1.24-es"
    ." verzióját, amely képes"
    ." együttműködni a MySQL régebbi"
    ." verzióval. Abban az esetben viszont"
    ." néhány új funkcióját nem fogod"
    ." tudni használni a MySQLDumper-nek.";
...
$lang['L_NOT_SUPPORTED']="This backup doesn't support this"
    ." function.";
$lang['L_NO_DB_FOUND']="Nem találhatóak adatbázisok!
Nyisd"
    ." meg a kapcsolódási paramétereket"
    ." és írd be az adatbázisnevet.";
$lang['L_NO_DB_FOUND_INFO']="Kapcsolat az adatbázishoz sikeresen"
    ." létrejött.<br />
A felhasználói"
    ." adataid érvényesek és elfogadta"
    ." őket a MySQL-szerver.<br />
Viszont a"
