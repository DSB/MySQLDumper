...
$lang['L_CONFIG_LOADED']="Configuratie \"%s\" is succesvol"<br />    ." ge�mporteerd.";
...
$lang['L_CONVERT_FINISHED']="Conversie be�ndigd, '%s' is"<br />    ." succesvol geschreven.";
...
$lang['L_NOGZPOSSIBLE']="Omdat Zlib niet is ge�nstalleerd,"<br />    ." kan u de GZip-Functies niet gebruiken!";
$lang['L_NONE']="geen";
...
$lang['L_NO_DB_FOUND_INFO']="De verbinding met de database is"<br />    ." succesvol gerealiseerd.<br /><br />Uw"<br />    ." userdata is actueel en is geaccepteerd"<br />    ." door de MySQL-Server.<br /><br />Maar"<br />    ." MySQLDumper is het niet gelukt enige"<br />    ." database te vinden.<br /><br />De"<br />    ." automatische detectie via script is"<br />    ." geblokkeerd op sommige servers.<br"<br />    ." /><br />U moet uw database handmatig"<br />    ." ingeven nadat de installatie is"<br />    ." bee�ndigd.<br />Klik op \"configuratie\""<br />    ." \"Connectie Parameter - toon\" en geef"<br />    ." de database naam daar in.";
