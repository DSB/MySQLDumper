...
$lang['L_ACTUALLY_INSERTED_RECORDS']="Dotychczas <b>%s</b> została dodana"<br />    ." do rekordów.";
$lang['L_ACTUALLY_INSERTED_RECORDS_OF']="To <b>%s</b> nagranie <b>%s</b>"<br />    ." zostało dodane pomyślnie.";
$lang['L_ADD']="Dodać";
$lang['L_ADDED']="dodaj";
...
$lang['L_ASKDBCOPY']="Czy chcesz skopiować zawartość bazy"<br />    ." danych  `%s` w bazie danych  `%s`?";
$lang['L_ASKDBDELETE']="Czy na pewno chcesz usunąć bazę"<br />    ." danych `%s` z zawartością?";
$lang['L_ASKDBEMPTY']="chcesz naprawdć opróżnić bazę"<br />    ." danych  `%s`?";
...
$lang['L_ASKTABLEEMPTYKEYS']="Czy chcesz wyczyścić tabelę `%s` i"<br />    ." umieścić wskazówki?";
...
$lang['L_BACKUP_TABLE_DONE']="Backup tabeli `%s` zakończony. %s"<br />    ." rejestry zostały przechowywane.";
$lang['L_BACK_TO_OVERVIEW']="Opis bazy danych";
$lang['L_CALL']="Call";
$lang['L_CANCEL']="Anulować";
$lang['L_CANT_CREATE_DIR']="Niemożliwe utworzyć katalog `%s`."<br />    ." Proszę utworzyć ten katalog ręcznie"<br />    ." przy użyciu FTP";
...
$lang['L_COMMAND_BEFORE_BACKUP']="Komenda przed utworzeniem kopii"<br />    ." zapasowej";
...
$lang['L_CONFIG_LOADED']="Konfiguracja \"%s\" został pomyślnie"<br />    ." zaimportowana.";
$lang['L_CONFIRM_CONFIGFILE_DELETE']="Czy na pewno chcesz usunąć plik"<br />    ." konfiguracyjny %s ?";
$lang['L_CONFIRM_DELETE_FILE']="Should the file '%s' really be"<br />    ." deleted?";
$lang['L_CONFIRM_DELETE_TABLES']="Wybrane tabele muszą być naprawdę"<br />    ." usunięte ?";
...
$lang['L_CRON_COMPLETELOG']="Zapisz wszystkie dane wyjściowe do"<br />    ." dziennika";
...
$lang['L_DELETE_HTACCESS']="Usuń ochrone katalogu (wymazać"<br />    ." .htaccess";
...
$lang['L_DONE']="Done!";
$lang['L_DONT_ATTACH_BACKUP']="Nie należy podłączać kopii"<br />    ." zapasowej";
...
$lang['L_HTACC_CONFIRM_DELETE']="Chcesz stworzyć teraz ochrone"<br />    ." katalogu";
...
$lang['L_HTACC_CREATE_ERROR']="Wystąpił błąd podczas tworzenia"<br />    ." pliku ochrony!<br />Prosimy ręcznie"<br />    ." utworzyć plik w następujący sposó";
...
$lang['L_HTACC_EXISTS']="Istnieje już ochrona katalogu. W"<br />    ." przypadku utworzenia nowego, zastąpi"<br />    ." ona stary!";
...
$lang['L_HTACC_WARNING']="Uwaga! . htaccess bezpośrednio"<br />    ." wpływa na zachowanie przeglądarki."<br />    ." <br/> Niewłaściwe treści mogą"<br />    ." sprawić, że witryna nie będzie"<br />    ." dostępna.";
...
$lang['L_MULTIDUMP']="Backup na kilka części: Bazy danych"<br />    ." %d zostały zapisane";
...
$lang['L_NOGZPOSSIBLE']="Jak Zlib nie jest zainstalowany, nie"<br />    ." można użyć funkcji GZip";
$lang['L_NONE']="bez";
...
$lang['L_NOT_SUPPORTED']="Ta kopia zapasowa nie obsługuje tej"<br />    ." funkcji";
...
$lang['L_PHPBUG']="Błąd w zlib! Brak możliwości"<br />    ." kompresji";
...
$lang['L_PRIMARYKEY_CONFIRMDELETE']="Czy na pewno usunąć podstawowy"<br />    ." klucz?";
...
$lang['L_SETPRIMARYKEYSFOR']="Ustaw nowe klucze podstawowe dla"<br />    ." tabeli";
...
$lang['L_TABLE_CREATE_SUCC']="Tabela '%s' została utworzona"<br />    ." pozytywnie";
...
$lang['L_WRONG_RIGHTS']="Nie można zapisać pliku lub katalogu"<br />    ." `%s`.<br />Chmods są źle skonfigurowane"<br />    ." lub właściwości nie są"<br />    ." dobre.<br />Sprawdź atrybuty przy użyciu"<br />    ." oprogramowania FTP.<br />Plik lub katalog"<br />    ." musi być w %s";
$lang['L_YES']="tak";
