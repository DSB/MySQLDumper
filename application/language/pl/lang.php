...
$lang['L_SAVING_DATA_TO_MULTIPART_FILE']="Maximum filesize reached: proceeding"
    ." with file '%s'";
$lang['L_SAVING_DB_FORM']="Bazy danych";
...
$lang['L_WRONG_RIGHTS']="Nie można zapisać pliku lub katalogu"
    ." `%s`.
Chmods są źle skonfigurowane"
    ." lub właściwości nie są"
    ." dobre.
Sprawdź atrybuty przy użyciu"
    ." oprogramowania FTP.
Plik lub katalog"
    ." musi być w %s";
$lang['L_YES']="tak";
