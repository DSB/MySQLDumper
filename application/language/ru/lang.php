...
$lang['L_ACTUALLY_INSERTED_RECORDS']="На данный момент"<br />    ." успешно занесенны"<br />    ." <b>%s</b> строк.";
$lang['L_ACTUALLY_INSERTED_RECORDS_OF']="На данный момент"<br />    ." успешно занесенны %s"<br />    ." из %s строк.";
$lang['L_ADD']="Добавить";
$lang['L_ADDED']="добавлено";
$lang['L_ADD_DB_MANUALLY']="Добавить базу данных"<br />    ." вручную.";
$lang['L_ADD_RECIPIENT']="Добавить получателя";
$lang['L_ALL']="все";
$lang['L_ANALYZE']="Проанализировать";
$lang['L_ANALYZING_TABLE']="В данный момент идёт"<br />    ." анализ базы данных"<br />    ." <b>%s</b>.";
$lang['L_ASKDBCOPY']="Скопировать"<br />    ." содержимое базы"<br />    ." данных '%s' в базу"<br />    ." данных '%s'?";
$lang['L_ASKDBDELETE']="Действительно"<br />    ." полностью удалить"<br />    ." базу данных %s?";
$lang['L_ASKDBEMPTY']="Действительно"<br />    ." опустошить базу"<br />    ." данных %s?";
$lang['L_ASKDELETEFIELD']="Действительно"<br />    ." удалить этот"<br />    ." столбец?";
$lang['L_ASKDELETERECORD']="Действительно"<br />    ." удалить эту строку?";
$lang['L_ASKDELETETABLE']="Действительно"<br />    ." удалить таблицу '%s'?";
$lang['L_ASKTABLEEMPTY']="Действительно"<br />    ." опустошить таблицу"<br />    ." '%s'?";
$lang['L_ASKTABLEEMPTYKEYS']="Действительно"<br />    ." опустошить таблицу"<br />    ." '%s' и удалить индексы?";
$lang['L_ATTACHED_AS_FILE']="Вложить файлом";
$lang['L_ATTACH_BACKUP']="Вложить резервную"<br />    ." копию";
$lang['L_AUTHENTICATE']="Данные входа в"<br />    ." систему";
$lang['L_AUTHORIZE']="Авторизировать";
$lang['L_AUTODELETE']="Автоматическое"<br />    ." удаление резервных"<br />    ." копий";
$lang['L_BACK']="назад";
$lang['L_BACKUPFILESANZAHL']="В папке резервных"<br />    ." копий находятся";
$lang['L_BACKUPS']="Резервные копии";
$lang['L_BACKUP_DBS']="Базы данных для"<br />    ." резервной копии";
$lang['L_BACKUP_TABLE_DONE']="Резеврная копия"<br />    ." таблицы '%s'"<br />    ." завершенна."<br />    ." Сохраненны %s строк.";
$lang['L_BACK_TO_OVERVIEW']="Список баз данных";
$lang['L_CALL']="Запуск";
$lang['L_CANCEL']="отмена";
$lang['L_CANT_CREATE_DIR']="Не получилось"<br />    ." создать папку '%s'."<br />    ." Пожалуйста, создайте"<br />    ." её с помощью вашего"<br />    ." FTP-клиента.";
$lang['L_CHANGE']="Изменить";
$lang['L_CHANGEDIR']="Перейти в другую"<br />    ." папку";
$lang['L_CHANGEDIRERROR']="Перейти в папку не"<br />    ." удалось!";
$lang['L_CHARSET']="Набор символов";
$lang['L_CHARSETS']="Character Sets";
$lang['L_CHECK']="Проверить";
$lang['L_CHECK_DIRS']="Проверить мои папки";
$lang['L_CHOOSE_CHARSET']="К сожалению MySQLDumper не"<br />    ." смог определить"<br />    ." автоматически в"<br />    ." какой кодировке была"<br />    ." создана ваша"<br />    ." резервная копия.<br /><br"<br />    ." /><br />Вы должны вручную"<br />    ." выбрать эту"<br />    ." кодировку.<br /><br /><br />После"<br />    ." этого MySQLDumper"<br />    ." установит"<br />    ." соединение к серверу"<br />    ." MySQL на эту кодировку"<br />    ." и начнёт"<br />    ." востановление"<br />    ." данных.<br /><br /><br />Если"<br />    ." после"<br />    ." восстановления у вас"<br />    ." в текстах окажутся"<br />    ." странные"<br />    ." неправильные"<br />    ." символы, попробуйте"<br />    ." вручную выбрать"<br />    ." другую кодировку.";
$lang['L_CHOOSE_DB']="выбрать базу данных";
$lang['L_CLEAR_DATABASE']="Опустошить базу"<br />    ." данных";
$lang['L_CLOSE']="Закрыть";
$lang['L_COLLATION']="Сортировка";
$lang['L_COMMAND']="Команда";
$lang['L_COMMAND_AFTER_BACKUP']="Команда после"<br />    ." сохранения"<br />    ." резервной копии";
$lang['L_COMMAND_BEFORE_BACKUP']="Команда поред"<br />    ." сохранением"<br />    ." резервной копии";
...
$lang['L_CONFIG_AUTODELETE']="Автоматическое"<br />    ." удаление";
$lang['L_CONFIG_CRONPERL']="Настройки crondump для"<br />    ." скриптов на perl";
$lang['L_CONFIG_EMAIL']="Оповещение по"<br />    ." электронной почте";
$lang['L_CONFIG_FTP']="Перенос файла"<br />    ." резервной копии по FTP";
$lang['L_CONFIG_HEADLINE']="Настройки";
$lang['L_CONFIG_INTERFACE']="Оболочка";
$lang['L_CONFIG_LOADED']="Конфигурация \"%s\""<br />    ." успешно загружена.";
$lang['L_CONFIRM_CONFIGFILE_DELETE']="Действительно"<br />    ." стереть файл"<br />    ." настроек %s?";
$lang['L_CONFIRM_DELETE_FILE']="Действительно"<br />    ." стереть файл %s?";
$lang['L_CONFIRM_DELETE_TABLES']="Действительно"<br />    ." стереть выбранные"<br />    ." таблицы?";
$lang['L_CONFIRM_DROP_DATABASES']="Действительно"<br />    ." стереть выбранные"<br />    ." базы"<br />    ." данных?<br /><br />Осторожно!"<br />    ." Все данные будут"<br />    ." безвозратно удалены!"<br />    ." Мы рекомендуем"<br />    ." сначала сделать"<br />    ." резервную копию этих"<br />    ." данных.";
$lang['L_CONFIRM_RECIPIENT_DELETE']="Действительно"<br />    ." удалить получателя"<br />    ." \"%s\"?";
...
$lang['L_CONFIRM_TRUNCATE_TABLES']="Действительно"<br />    ." опустошить"<br />    ." выбранные таблицы?";
$lang['L_CONNECT']="Соединиться";
$lang['L_CONNECTIONPARS']="Параметры"<br />    ." соединения";
...
$lang['L_CONVERTED_FILES']="Преобразованные"<br />    ." файлы";
$lang['L_CONVERTER']="Переобразователь"<br />    ." резервных копий";
...
$lang['L_CONVERT_TITLE']="Переобразовать"<br />    ." резервную копию в"<br />    ." формат MySQLDumper";
...
$lang['L_CREATE_CONFIGFILE']="Создать новый файл"<br />    ." конфигурации.";
$lang['L_CREATE_DATABASE']="создать новую базу"<br />    ." данных";
$lang['L_CREATE_TABLE_SAVED']="Definition of table `%s` saved.";
$lang['L_CREDITS']="Помощь / Участники"<br />    ." проекта";
$lang['L_CRONSCRIPT']="Cronscript";
$lang['L_CRON_COMMENT']="Enter Comment";
$lang['L_CRON_COMPLETELOG']="Записывать все"<br />    ." операции в лог";
...
$lang['L_CSV_FIELDSLINES']="Количество найденых"<br />    ." полей: %d, всего строк:"<br />    ." %d";
...
$lang['L_DB_DEFAULT']="База данных по"<br />    ." умолчанию";
...
$lang['L_DB_USER']="Имя пользователя"<br />    ." базы данных";
...
$lang['L_DELETE_HTACCESS']="Удалить защиту папки"<br />    ." (.htaccess)";
...
$lang['L_DONE']="Готово!";
$lang['L_DONT_ATTACH_BACKUP']="Не вкладывать"<br />    ." резервную копию";
...
$lang['L_DUMP']="Сделать резервную"<br />    ." копию";
...
$lang['L_DUMP_NOTABLES']="В базе данных `%s` нет"<br />    ." никаких таблиц.";
...
$lang['L_ESTIMATED_END']="Предпологаемый"<br />    ." конец";
...
$lang['L_FILE_SAVED_SUCCESSFULLY']="Файл успешно"<br />    ." сохранён";
$lang['L_FILE_SAVED_UNSUCCESSFULLY']="При сохранении файла"<br />    ." произошла ошибка";
...
$lang['L_FM_ASKDELETE1']="Вы действительно"<br />    ." хотите стереть файлы";
...
$lang['L_FM_FREESPACE']="Свободное место на"<br />    ." сервере";
...
$lang['L_HOUR']="час";
$lang['L_HOURS']="часов";
$lang['L_HTACC_ACTIVATE_REWRITE_ENGINE']="Активировать"<br />    ." преобразование";
$lang['L_HTACC_ADD_HANDLER']="Добавить обработчик";
$lang['L_HTACC_CONFIRM_DELETE']="Создать защиту папки"<br />    ." прямо сейчас?";
$lang['L_HTACC_CONTENT']="Содержимое файла";
$lang['L_HTACC_CREATE']="создать защиту папки";
$lang['L_HTACC_CREATED']="Защита папки"<br />    ." созданна.";
$lang['L_HTACC_CREATE_ERROR']="При попытке создания"<br />    ." защиты папки"<br />    ." произошла ошибка!<br"<br />    ." />Создайте,"<br />    ." пожалуйста, вручную"<br />    ." файл со следующим"<br />    ." содержанием";
$lang['L_HTACC_CRYPT']="Crypt (макс. 8 знаков,"<br />    ." системы Linux и Windows)";
$lang['L_HTACC_DENY_ALLOW']="Запретить /"<br />    ." Разрешить";
$lang['L_HTACC_DIR_LISTING']="Обзор папки";
$lang['L_HTACC_EDIT']="Редактировать .htaccess";
$lang['L_HTACC_ERROR_DOC']="Страница ошибки";
$lang['L_HTACC_EXAMPLES']="Примеры и"<br />    ." документация .htaccess";
$lang['L_HTACC_EXISTS']="Защита папки уже"<br />    ." существует";
...
$lang['L_HTACC_NO_USERNAME']="Задайте имя"<br />    ." пользователя!";
$lang['L_HTACC_PROPOSED']="Настоятельно"<br />    ." рекомендовано";
$lang['L_HTACC_REDIRECT']="Перенаправление";
$lang['L_HTACC_SCRIPT_EXEC']="Запустить скрипт";
$lang['L_HTACC_SHA1']="SHA1 (все системы)";
$lang['L_HTACC_WARNING']="Внимание! .htaccess"<br />    ." влияет на"<br />    ." доступность"<br />    ." страницы. При"<br />    ." неправильном"<br />    ." приминении доступ к"<br />    ." страницам будет"<br />    ." невозможен.";
...
$lang['L_INFO_DATABASES']="Доступные базы"<br />    ." данных";
$lang['L_INFO_DBEMPTY']="База данных пуста!";
$lang['L_INFO_FSOCKOPEN_DISABLED']="К сожалению на этом"<br />    ." сервере PHP функция"<br />    ." fsockopen() выключена в"<br />    ." настройках сервера."<br />    ." Поэтому языковые"<br />    ." пакеты не могут быть"<br />    ." скачаны"<br />    ." автоматически.<br /><br />Однако,"<br />    ." вы можете скачать"<br />    ." нужные пакеты"<br />    ." вручную, распаковать"<br />    ." и загрузить их с"<br />    ." помощью FTP менеджера"<br />    ." в папку \"languages\" в"<br />    ." вашей версии MySQLDumper."<br />    ." После этого вы"<br />    ." сможете выбрать"<br />    ." здесь эти пакеты.";
$lang['L_INFO_LASTUPDATE']="Последнее"<br />    ." обновление";
$lang['L_INFO_LOCATION']="Вы находитесь на";
$lang['L_INFO_NODB']="База данных не"<br />    ." существует.";
$lang['L_INFO_NOPROCESSES']="Нет работающих"<br />    ." процесов";
...
$lang['L_LASTBACKUP']="Последняя резервная"<br />    ." копия";
$lang['L_LOAD']="Load default settings";
$lang['L_LOAD_DATABASE']="Перезагрузить базы"<br />    ." данных";
$lang['L_LOAD_FILE']="Загрузить файл";
$lang['L_LOG']="Лог";
$lang['L_LOGFILENOTWRITABLE']="Не получилось"<br />    ." записать файл лога.";
$lang['L_LOGFILES']="Logfiles";
$lang['L_LOGGED_IN']="Logged in";
$lang['L_LOGIN']="Login";
$lang['L_LOGIN_AUTOLOGIN']="Automatic login";
$lang['L_LOGIN_INVALID_USER']="Пользователя с таким"<br />    ." именем и паролем не"<br />    ." существует.";
...
$lang['L_MAX_BACKUP_FILES_EACH2']="Для каждой базы"<br />    ." данных";
$lang['L_MAX_EXECUTION_TIME']="Максимальное время"<br />    ." выполнения";
...
$lang['L_MULTIPART_SIZE']="Максимальный размер"<br />    ." файла";
$lang['L_MULTI_PART']="Составная резервная"<br />    ." копия";
$lang['L_MYSQLVARS']="переменные MySQL";
$lang['L_MYSQL_CLIENT_VERSION']="Версия клиентской"<br />    ." программы MySQL";
$lang['L_MYSQL_CONNECTION_ENCODING']="Стандартная"<br />    ." кодировка сервера"<br />    ." MySQL";
...
$lang['L_NO']="нет";
$lang['L_NOFTPPOSSIBLE']="Функции FTP"<br />    ." отсутсвуют";
$lang['L_NOGZPOSSIBLE']="Фунции GZip"<br />    ." отсутствую, как как"<br />    ." не установлено"<br />    ." расширение zlib";
$lang['L_NONE']="Никакие";
...
$lang['L_OS']="Операционная"<br />    ." система";
$lang['L_OVERHEAD']="Overhead";
$lang['L_PAGE']="Page";
$lang['L_PAGE_REFRESHS']="Обновления страниц";
$lang['L_PASS']="Password";
$lang['L_PASSWORD']="Password";
$lang['L_PASSWORDS_UNEQUAL']="Пароли не совпадают"<br />    ." либо пусты.";
...
$lang['L_PHPBUG']="Ошибка в zlib! Сжатие"<br />    ." невозможно.";
...
$lang['L_PRIMARYKEYS_SAVE']="Сохранить первичные"<br />    ." ключи";
$lang['L_PRIMARYKEY_CONFIRMDELETE']="Действительно"<br />    ." удалить первичные"<br />    ." ключи?";
$lang['L_PRIMARYKEY_DELETED']="Primary key deleted";
$lang['L_PRIMARYKEY_FIELD']="Поле первичного"<br />    ." ключа";
$lang['L_PRIMARYKEY_NOTFOUND']="Primary key not found";
$lang['L_PROCESSKILL1']="Пытаюсь закончить"<br />    ." процесс";
$lang['L_PROCESSKILL2']=".";
$lang['L_PROCESSKILL3']="Пытаюсь уже";
$lang['L_PROCESSKILL4']="секунд(у) закончить"<br />    ." процесс";
$lang['L_PROCESS_ID']="Process ID";
$lang['L_PROGRESS_FILE']="Статус обработки"<br />    ." файла";
...
$lang['L_RECORDS_PER_PAGECALL']="Строк за вызов"<br />    ." страницы";
...
$lang['L_TABLE_CREATE_SUCC']="Таблица '%s' успешно"<br />    ." созданна.";
...
$lang['L_VIEW']="view";
$lang['L_VISIT_HOMEPAGE']="Посетить домашний"<br />    ." сайт";
$lang['L_VOM']="from";
$lang['L_WITH']="с";
