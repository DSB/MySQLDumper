...
$lang['L_ACTUALLY_INSERTED_RECORDS']="Doteraz <b>%s</b> Záznamov bolo"<br />    ." úspešne pridaných.";
$lang['L_ACTUALLY_INSERTED_RECORDS_OF']="Práve  <b>%s</b> záznamov zo"<br />    ." <b>%s</b>  bolo úspešne pridané.";
$lang['L_ADD']="Pridať";
...
$lang['L_ASKDBCOPY']="Chcete skopírovať databázu `%s` k"<br />    ." databáze `%s`?";
$lang['L_ASKDBDELETE']="Ak chcete odstrániť databázu `%s` s"<br />    ." obsahom?";
$lang['L_ASKDBEMPTY']="Prajete si vyprázdniť databázu `%s`"<br />    ." ?";
$lang['L_ASKDELETEFIELD']="Chcete odstrániť polia?";
$lang['L_ASKDELETERECORD']="Ste si istí,že chcete zmazať tento"<br />    ." záznam?";
$lang['L_ASKDELETETABLE']="V prípade, že tabuľka `%s` bude"<br />    ." zmazaná?";
$lang['L_ASKTABLEEMPTY']="V prípade, že tabuľka `%s` bude"<br />    ." zmazaná?";
$lang['L_ASKTABLEEMPTYKEYS']="Prajete si vymazať tabuľku `%s` a"<br />    ." resetovať indexy?";
...
$lang['L_BACKUP_TABLE_DONE']="Záloha tabuľky `%s`dokončená.%s"<br />    ." záznamov bolo uložených.";
$lang['L_BACK_TO_OVERVIEW']="Databáza Prehľad";
$lang['L_CALL']="Volať";
$lang['L_CANCEL']="Koniec";
$lang['L_CANT_CREATE_DIR']="Nepodarilo sa vytvoriť adresár '%s'."<br />    ." <br />Prosím, vytvorte ho pomocou FTP"<br />    ." klienta.";
$lang['L_CHANGE']="zmena";
...
$lang['L_CONFIG_CRONPERL']="Cron zalohovanie - Nastavenia pre Perl"<br />    ." skript";
...
$lang['L_CONFIG_LOADED']="Nastavenie \"%s\" bolo úspešne"<br />    ." nahraté.";
$lang['L_CONFIRM_CONFIGFILE_DELETE']="Naozaj zmazať Nastavenie zalohovania"<br />    ." %s?";
$lang['L_CONFIRM_DELETE_FILE']="Naozaj si prajete vymazať zálohu"<br />    ." '%s' ?";
$lang['L_CONFIRM_DELETE_TABLES']="Naozaj zmazať vybrané tabuľky?";
$lang['L_CONFIRM_DROP_DATABASES']="Prajete si vybrané databázy naozaj "<br />    ." vymazať? Upozornenie: Všetky údaje"<br />    ." budú vymazané! Možno by ste mali"<br />    ." vytvoriť zálohu .";
$lang['L_CONFIRM_RECIPIENT_DELETE']="Prajete si príjemcu \"%s\" naozaj"<br />    ." odstrániť?";
$lang['L_CONFIRM_TRUNCATE_DATABASES']="Prajete si vymazať všetky tabuľky"<br />    ." vybraných databáz s? Upozornenie:"<br />    ." Všetky údaje budú vymazané! Možno"<br />    ." by ste mali urobiť zálohu pre"<br />    ." neskoršie obnovenie.";
$lang['L_CONFIRM_TRUNCATE_TABLES']="Naozaj chcete vyprazdnit vybrané"<br />    ." tabuľky?";
$lang['L_CONNECT']="pripojiť";
$lang['L_CONNECTIONPARS']="Nastavenie pripojenia";
$lang['L_CONNECTTOMYSQL']="Pripojit k MySQL";
$lang['L_CONTINUE_MULTIPART_RESTORE']="Spustiť viacdielne obnovenie zalohy "<br />    ." '%s' .";
...
$lang['L_CONVERT_FILENAME']="Meno cieľového súboru (bez"<br />    ." prípony)";
$lang['L_CONVERT_FILEREAD']="Konvertovania zálohy '%s'";
$lang['L_CONVERT_FINISHED']="Dokončenie konverzie, '%s' bolo"<br />    ." úspešne.";
$lang['L_CONVERT_START']="Začať konvertovať";
$lang['L_CONVERT_TITLE']="Konvertovať zálohu na MSD Format";
$lang['L_CONVERT_WRONG_PARAMETERS']="Zlé nastavenie!  Konvertovanie nie je"<br />    ." možné.";
...
$lang['L_CSV_FIELDCOUNT_NOMATCH']="Počet polí nesúhlasí s udajmy o"<br />    ." presune (%d namiesto %d).";
...
$lang['L_CSV_NODATA']="Neboly nájdené žiadne dáta pre"<br />    ." import!";
...
$lang['L_DATASIZE_INFO']="Toto je veľkosť dát - nie veľkosť"<br />    ." súboru zálohy";
$lang['L_DAY']="Deň";
$lang['L_DAYS']="Dni";
$lang['L_DB']="Databáza";
...
$lang['L_DB_IN_LIST']="Databázu '%s' sa nepodarilo pridať,"<br />    ." pretože už existuje.";
$lang['L_DB_NAME']="Názov databázy";
$lang['L_DB_PASS']="Heslo";
$lang['L_DB_SELECT_ERROR']="<br />Chyba:<br />Výber z databázy"<br />    ." <b>";
...
$lang['L_DELETE_FILE_ERROR']="Chyba pri odstraňovaní zálohy"<br />    ." \"%s\"!";
$lang['L_DELETE_FILE_SUCCESS']="Záloha \"%s\" bola úspešne"<br />    ." odstránená.";
$lang['L_DELETE_HTACCESS']="Odstráňiť ochranu adresárov"<br />    ." (zmazať .htaccess)";
...
$lang['L_DUMP']="Záloha";
$lang['L_DUMP_ENDERGEBNIS']="Záloha obsahuje <b>%s</b> tabuliek a"<br />    ." <b>%s</b> záznamov.<br />";
$lang['L_DUMP_FILENAME']="Názov zalohy";
$lang['L_DUMP_HEADLINE']="Vytváram zálohu...";
$lang['L_DUMP_NOTABLES']="Nenašli sa žiadne tabuľky v"<br />    ." databáze `<b>%s</b>`";
$lang['L_DUMP_OF_DB_FINISHED']="Zálohovanie databázy `%s`"<br />    ." dokončené";
$lang['L_DURATION']="Doba trvania";
$lang['L_EDIT']="upraviť";
$lang['L_EHRESTORE_CONTINUE']="pokračovať v prepisovaní a"<br />    ." nahrávaní chyby";
$lang['L_EHRESTORE_STOP']="stop";
$lang['L_EMAIL']="Mail";
$lang['L_EMAILBODY_ATTACH']="Príloha obsahuje zálohu"<br />    ." MySQL-Databaze.<br />Zálohovanie"<br />    ." databázy `%s`<br /><br /><br"<br />    ." />Nasledujúci súbor bol"<br />    ." vytvorený:<br /><br />%s <br /><br"<br />    ." />>S pozdravom<br /><br"<br />    ." />MySQLDumper<br />";
$lang['L_EMAILBODY_FOOTER']="`<br /><br />S pozdravom<br /><br"<br />    ." />MySQLDumper<br />";
$lang['L_EMAILBODY_MP_ATTACH']="Rozdelená Záloha bola vytvorená.<br"<br />    ." />Záložné súbory sú pripojené na"<br />    ." samostatné e-maily.<br />Zálohovanie"<br />    ." databázy `%s`<br /><br /><br"<br />    ." />Nasledujúce súbory boli"<br />    ." vytvorené:<br /><br />%s <br /><br"<br />    ." />S pozdravom<br /><br"<br />    ." />MySQLDumper<br />";
$lang['L_EMAILBODY_MP_NOATTACH']="Rozdelená Záloha bola vytvorená.<br"<br />    ." />Záložné súbory nie sú"<br />    ." pripojené na tento e-mail!<br"<br />    ." />Zálohovanie databázy `%s`<br /><br"<br />    ." /><br />Nasledujúce súbory boli"<br />    ." vytvorené:<br /><br />%s<br /><br /><br"<br />    ." />S pozdravom<br /><br"<br />    ." />MySQLDumper<br />";
$lang['L_EMAILBODY_NOATTACH']="Súbory nie sú pripojené na tento"<br />    ." e-mail!<br />Zálohovanie databázy"<br />    ." `%s`<br /><br /><br />Nasledujúce súbory"<br />    ." boli vytvorené:<br /><br />%s<br /><br"<br />    ." /><br />S pozdravom<br /><br"<br />    ." />MySQLDumper<br />";
$lang['L_EMAILBODY_TOOBIG']="Záložný súbor prekročil"<br />    ." maximálnu veľkosť % s, a nebolo"<br />    ." pripojené k tomuto e-mailu.<br"<br />    ." />Zálohovanie databázy `%s`<br /><br"<br />    ." /><br />Nasledujúci súbor bol"<br />    ." vytvorený:<br /><br />%s<br /><br /><br"<br />    ." />S pozdravom<br /><br"<br />    ." />MySQLDumper<br />";
...
$lang['L_ENGINE']="Typ";
$lang['L_ENTER_DB_INFO']="Skôr kliknite na tlačidlo \"Pripojit"<br />    ." k MySQL\". Tu zadajte názov databázy"<br />    ." len vtedy pokial sa neda pripojit k"<br />    ." databaze.";
$lang['L_ENTRY']="Vstup";
$lang['L_ERROR']="Chyba";
...
$lang['L_ERROR_DELETING_CONFIGFILE']="Chyba: nemožno odstrániť"<br />    ." konfiguračný súbor %s!";
$lang['L_ERROR_LOADING_CONFIGFILE']="Nepodarilo sa načítať"<br />    ." konfiguračný súbor \"%s\".";
$lang['L_ERROR_LOG']="Chyba Logu";
$lang['L_ERROR_MULTIPART_RESTORE']="Viacdielna-Obnova: Nemôžem nájst"<br />    ." další zalohovací súbor '%s'!";
...
$lang['L_FATAL_ERROR_DUMP']="Vážna chyba: Správa o vytvorení"<br />    ." tabuľky '%s' v databaze '%s' sa nedá"<br />    ." čítať!";
...
$lang['L_FM_ASKDELETE3']="Prajete si zmazať automazania a"<br />    ." nastavit nové pravidlá pre"<br />    ." automazanie?";
$lang['L_FM_ASKDELETE4']="Prajete si zmazať všetky zálohy?";
$lang['L_FM_ASKDELETE5']="Prajete si zmazať všetky zálohy s"<br />    ." príponou";
$lang['L_FM_ASKDELETE5_2']="*  Teraz odstrániť?";
$lang['L_FM_AUTODEL1']="Automazanie: Nasledujúce zálohy boli"<br />    ." vymazané, pretože maximálne"<br />    ." ponechanie záloh na ftp je:";
...
$lang['L_FM_UPLOADFILEEXISTS']="Záloha s rovnakým názvom už"<br />    ." existuje !";
$lang['L_FM_UPLOADFILEREQUEST']="prosím, vyberte súbor.";
$lang['L_FM_UPLOADMOVEERROR']="Nepodarilo sa presunúť zálohu do"<br />    ." zvoleného adresára .";
...
$lang['L_FTP_CONFIRM_DELETE']="Chcete toto FTP pripojenie  naozaj"<br />    ." odstrániť?";
...
$lang['L_FTP_CONNECTION_ERROR']="Pripojenie na server '% s' pomocou"<br />    ." portu% s nemoholo byť stanovené";
$lang['L_FTP_CONNECTION_SUCCESS']="Pripojenie na server '% s' pomocou"<br />    ." portu% s bolo úspešné";
$lang['L_FTP_DIR']="Nahrať do adresára";
$lang['L_FTP_FILE_TRANSFER_ERROR']="Prevod zálohy '% s' bol chybný";
$lang['L_FTP_FILE_TRANSFER_SUCCESS']="Záloha '% s' bola prevedená"<br />    ." úspešne";
$lang['L_FTP_LOGIN_ERROR']="Prihlásenie užívateľom '% s' bolo"<br />    ." zamietnuté";
$lang['L_FTP_LOGIN_SUCCESS']="Prihlásenie užívateľom '% s' bolo"<br />    ." úspešné";
$lang['L_FTP_OK']="Pripojenie úspešné.";
$lang['L_FTP_PASS']="Heslo";
$lang['L_FTP_PASSIVE']="používať pasívny mód";
$lang['L_FTP_PASV_ERROR']="Zmena v pasívnom režime FTP nebola"<br />    ." úspešná";
$lang['L_FTP_PASV_SUCCESS']="Zmena v pasívnom režime FTP bola"<br />    ." úspešná";
$lang['L_FTP_PORT']="Port";
$lang['L_FTP_SEND_TO']="z <strong>%s</strong><br /> do"<br />    ." <strong>%s</strong>";
...
$lang['L_HTACC_CONFIRM_DELETE']="Prajete si vytvoriť adresár ochrany"<br />    ." ?";
...
$lang['L_HTACC_CREATE_ERROR']="Došlo k chybe pri vytváraní"<br />    ." adresára ochrany !<br />Prosím"<br />    ." vytvorte ručne 2 súbory s"<br />    ." nasledujúcim obsahom";
...
$lang['L_HTACC_EXISTS']="V súčasnosti už existuje adresár"<br />    ." ochrany. Keď vytvoríte nový, tím"<br />    ." prepíšete starý!";
...
$lang['L_HTACC_WARNING']="Pozor! . Htaccess priamo ovplyvňuje"<br />    ." správanie prehliadača. <br /> Pri"<br />    ." nesprávnom obsahu, môže byť že"<br />    ." vaše stránky už nebudú dostupné";
...
$lang['L_LOGIN_INVALID_USER']="Neznáma kombinácia užívateľského"<br />    ." mena a hesla.";
...
$lang['L_LOG_NOT_READABLE']="Log súbor '%s' neexistuje, alebo nie"<br />    ." je čitateľný.";
...
$lang['L_MAX_UPLOAD_SIZE_INFO']="Ak je vaša záloha vätšia, ako je"<br />    ." vyššie uvedené obmedzenia, musíte"<br />    ." ju  nahrať pomocou FTP do"<br />    ." adresára\"work/backup\". <br />Po tomto"<br />    ." môžete pokračovať.";
$lang['L_MEMORY']="Pamäť";
...
$lang['L_NOGZPOSSIBLE']="Vzhľadom k tomu,%ze Zlib nie je"<br />    ." nainštalovaný, nemožno použiť"<br />    ." gzip-Funkciu!";
$lang['L_NONE']="žiadny";
...
$lang['L_NUMBER_OF_FILES_FORM']="Zmazať podľa počtu záloh v jednej"<br />    ." databáze";
$lang['L_OF']="z";
$lang['L_OK']="OK";
$lang['L_OPTIMIZE']="Optimalizácia tabuľky";
$lang['L_OPTIMIZE_TABLES']="Optimalizovať tabuľky pred"<br />    ." Zálohovaním";
$lang['L_OPTIMIZE_TABLE_ERR']="Chyba Optimalizácie tabuľky `%s`.";
$lang['L_OPTIMIZE_TABLE_SUCC']="Tabuľka `%s` bola úspešne"<br />    ." optimalizovaná.";
...
$lang['L_PASSWORDS_UNEQUAL']="Heslá nie sú zhodné alebo prázdne"<br />    ." !";
$lang['L_PASSWORD_REPEAT']="Heslo (opakovať)";
$lang['L_PASSWORD_STRENGTH']="Sila hesla";
$lang['L_PERLOUTPUT1']="Vstup do crondump.pl pre"<br />    ." absolute_path_of_configdir";
$lang['L_PERLOUTPUT2']="URL pre prehliadače alebo pre"<br />    ." externú prácu Cron";
...
$lang['L_PHP_VERSION_TOO_OLD']="Je nám ľúto: nainštalovaná"<br />    ." PHP-verzia je príliš zastaralá."<br />    ." MySQLDumper potrebuje PHP-verziu %s"<br />    ." alebo vyššiu. Táto  PHP-verzia %s,"<br />    ." je príliš zastaralá. Musíte"<br />    ." aktualizovať PHP-verziu, než budete"<br />    ." môcť nainštalovať a používať"<br />    ." MySQLDumper.";
...
$lang['L_RESTORE_DB_COMPLETE_IN']="Obnovenie databázy '%s' in %s"<br />    ." ukončené.";
$lang['L_RESTORE_OF_TABLES']="Vyberte tabuľky ktoré majú byť"<br />    ." obnovené";
$lang['L_RESTORE_TABLE']="Obnova tabuľky '%s' dokončená";
$lang['L_RESTORE_TABLES_COMPLETED']="Práve <b>%d</b> tabuliek zo <b>%d</b>"<br />    ."  bolo vytvorených.";
...
$lang['L_SAVE_SUCCESS']="Nastavenie bolo úspešne uložené do"<br />    ." nastavenia zálohovania \"%s\".";
$lang['L_SAVING_DATA_TO_FILE']="Ukladanie dát z databázy '% s' do"<br />    ." zálohy '% s'";
$lang['L_SAVING_DATA_TO_MULTIPART_FILE']="Maximálna veľkosť zálohy bola"<br />    ." dosiahnutá: Pokračovanie v zálohe"<br />    ." '% s'";
$lang['L_SAVING_DB_FORM']="Databáza";
$lang['L_SAVING_TABLE']="Uložené tabuľky";
$lang['L_SEARCH_ACCESS_KEYS']="Prehľadávať: dopredu = ALT + V,"<br />    ." dozadu = ALT + C";
$lang['L_SEARCH_IN_TABLE']="Vyhľadávanie v tabuľke";
$lang['L_SEARCH_NO_RESULTS']="Vyhľadávanie \"<b>%s</b>\" v"<br />    ." tabuľke \"<b>%s</b>\" nenašlo"<br />    ." žiadne výsledky!";
$lang['L_SEARCH_OPTIONS']="Možnosti hľadania";
$lang['L_SEARCH_OPTIONS_AND']="kolónka musí obsahovať všetky"<br />    ." hľadané slová (AND-search)";
$lang['L_SEARCH_OPTIONS_CONCAT']="riadok musí obsahovať všetky"<br />    ." hľadané slová, ale môžu byť v"<br />    ." každom stĺpci (môže to nejaký"<br />    ." čas trvať)";
$lang['L_SEARCH_OPTIONS_OR']="stĺpce musia mať jeden z hľadaných"<br />    ." slov (OR-search)";
$lang['L_SEARCH_RESULTS']="Vyhľadávanie \"<b>%s</b>\" v"<br />    ." tabuľke \"<b>%s</b>\" prináša"<br />    ." nasledujúce výsledky";
...
$lang['L_SETPRIMARYKEYSFOR']="Nastavte nové primárne kľúče na"<br />    ." tabuľku";
...
$lang['L_SQL_DBCOPY']="Obsah databázy `%s` bol kopírovaný"<br />    ." k databáze `%s`.";
$lang['L_SQL_DBSCOPY']="Štruktúra databázy `%s` bola"<br />    ." kopírovaná k databáze `%s`.";
...
$lang['L_SQL_NOFIELDDELETE']="Zmazať, nie je možné, pretože"<br />    ." tabuľky musí obsahovať aspoň jedno"<br />    ." pole.";
...
$lang['L_SQL_OUT5']="Vzhľadom k tomu, výstup obsahuje"<br />    ." viac ako 5000 riadkov nie je"<br />    ." zobrazená.";
...
$lang['L_SQL_SCOPY']="Štruktúra tabuľky `%s` bola"<br />    ." kopírovaná k tabuľke `%s`.";
...
$lang['L_SQL_TABLEEMPTIEDKEYS']="Tabuľka `%s` bola zmazaná a indexi"<br />    ." boli resetované.";
...
$lang['L_SQL_TCOPY']="Tabuľka `%s` bola kopírovaná s"<br />    ." dátami k tabuľke `%s`.";
...
$lang['L_SQL_WARNING']="Vykonávanie príkazov SQL môžete"<br />    ." manipulovať s dátami. Pamätajte!"<br />    ." Autori, nenesú žiadnu zodpovednosť"<br />    ." za poškodenie alebo stratu dát.";
$lang['L_SQL_WASCREATED']="bol vytvorený";
$lang['L_SQL_WASEMPTIED']="bol vyprázdnený";
$lang['L_STARTDUMP']="Spustiť";
$lang['L_START_RESTORE_DB_FILE']="Spustenie obnovenia databázy '%s' zo"<br />    ." zálohy '%s'.";
$lang['L_START_SQL_SEARCH']="začať hľadať";
$lang['L_STATUS']="Stav";
$lang['L_STEP']="Krok";
$lang['L_SUCCESS_CONFIGFILE_CREATED']="Nastavenie zálohovania %s bolo"<br />    ." úspešne vytvorené.";
$lang['L_SUCCESS_DELETING_CONFIGFILE']="Nastavenie zálohovania %s bolo"<br />    ." úspešne odstránené.";
...
$lang['L_TABLE_CREATE_SUCC']="Tabuľka '%s'  bola úspešne"<br />    ." vytvorená.";
...
$lang['L_TOOLS_TOOLBOX']="Vybrať databázu / Funkcie Databázy"<br />    ." / Import - Export";
...
$lang['L_UPDATE_CONNECTION_FAILED']="Aktualizácia sa nepodarila, pretože"<br />    ." pripojenie k serveru '%s' sa nedá"<br />    ." vytvoriť.";
...
$lang['L_WRONGCONNECTIONPARS']="Parametre pripojenia zlé alebo"<br />    ." chýbajúce!";
$lang['L_WRONG_CONNECTIONPARS']="Parametre pripojenia sú mylné !";
$lang['L_WRONG_RIGHTS']="Do adresára'%s' nemožno"<br />    ." zapisovať.<br /><br />Práva (chmod), nie"<br />    ." sú nastavené správne, alebo je zlý"<br />    ." vlastník.<br /><br />Prosí nastavte"<br />    ." správne atribúty pomocou FTP"<br />    ." klienta.<br /><br />Súbor alebo adresár"<br />    ." musí byť nastavený na %s.<br />";
$lang['L_YES']="áno";
$lang['L_ZEND_FRAMEWORK_VERSION']="Zend Framework verzia";
$lang['L_ZEND_ID_ACCESS_NOT_A_DIRECTORY']="Názov súboru '% Hodnoty %' nie je"<br />    ." adresár.";
$lang['L_ZEND_ID_ACCESS_NOT_A_FILE']="Meno '% hodnoty%' nie je súbor.";
$lang['L_ZEND_ID_ACCESS_NOT_A_LINK']="Meno '% hodnoty %' nie je odkaz.";
$lang['L_ZEND_ID_ACCESS_NOT_EXECUTABLE']="Meno súboru alebo priečinka '%"<br />    ." hodnoty %' nevymáhateľné.";
$lang['L_ZEND_ID_ACCESS_NOT_EXISTS']="Názov súboru alebo priečinka '%"<br />    ." hodnoty %' neexistuje";
$lang['L_ZEND_ID_ACCESS_NOT_READABLE']="Súbor alebo adresár '% hodnoty %'"<br />    ." nevie čítať.";
$lang['L_ZEND_ID_ACCESS_NOT_UPLOADED']="Súbor '% hodnota %' sa nedá nahrať.";
$lang['L_ZEND_ID_ACCESS_NOT_WRITABLE']="Súbor alebo adresár '% hodnota %'"<br />    ." nieje zapisovaťeľny.";
$lang['L_ZEND_ID_DIGITS_INVALID']="Neplatný typ. Reťazec, integer alebo"<br />    ." float sa očakávalo.";
$lang['L_ZEND_ID_DIGITS_STRING_EMPTY']="Hodnota je prázdny reťazec.";
$lang['L_ZEND_ID_EMAIL_ADDRESS_DOT_ATOM']="E-mailová adresa nemôže byť"<br />    ." preverená z hľadiska \"dot-atóm"<br />    ." formáte.";
$lang['L_ZEND_ID_EMAIL_ADDRESS_INVALID']="Zadaný neplatný typ. Reťazec sa"<br />    ." očakávalo.";
$lang['L_ZEND_ID_EMAIL_ADDRESS_INVALID_FORMAT']="Formát e-mailová adresa nie je"<br />    ." platná";
$lang['L_ZEND_ID_EMAIL_ADDRESS_INVALID_HOSTNAME']="Názov domény nie je platný.";
$lang['L_ZEND_ID_EMAIL_ADDRESS_INVALID_LOCAL_PART']="Táto časť e-mailovej adresy"<br />    ." (<local-part>@<domain>.<tld>) je"<br />    ." neplatná.";
$lang['L_ZEND_ID_EMAIL_ADDRESS_INVALID_MX_RECORD']="Pre e-mailovú adresu nie je platný"<br />    ." MX záznam.";
$lang['L_ZEND_ID_EMAIL_ADDRESS_INVALID_SEGMENT']="The hostname ist located in a not"<br />    ." routable network segment. E-mailové"<br />    ." adresy nie sú akceptované z verejnej"<br />    ." siete.";
$lang['L_ZEND_ID_EMAIL_ADDRESS_LENGTH_EXCEEDED']="E-mailová adresa je príliš dlhá."<br />    ." Môžete byť až 320 znakov.";
$lang['L_ZEND_ID_EMAIL_ADDRESS_QUOTED_STRING']="E-mail adresa nemôže byť uzavretá"<br />    ." prw Quoted-formáte reťazca.";
$lang['L_ZEND_ID_IS_EMPTY']="Hodnota je povinná a nesmie byť"<br />    ." prázdna.";
$lang['L_ZEND_ID_MISSING_TOKEN']="Žiadna funkcia na kontrolu";
$lang['L_ZEND_ID_NOT_DIGITS']="Len číslice sú povolené.";
$lang['L_ZEND_ID_NOT_EMPTY_INVALID']="Typ hodnoty je neplatný. Očakáva"<br />    ." sa, reťazec, celé číslo, float,"<br />    ." boolean alebo pole.";
$lang['L_ZEND_ID_NOT_SAME']="Tieto dve uvedené charakteristiky"<br />    ." nezodpovedajú.";
return $lang;
