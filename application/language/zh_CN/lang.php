...
'L_ACTION' => '',
'L_ACTIVATED' => '激活',
'L_ACTUALLY_INSERTED_RECORDS' => '到目前为止已有 <b>%s</b> 条记录已经成功增加。',
'L_ACTUALLY_INSERTED_RECORDS_OF' => '到目前为止已有 <b>%s</b> / <b>%s</b> 条记录已经成功增加。',
'L_ADD' => '增加',
'L_ADDED' => '已增加',
'L_ADD_DB_MANUALLY' => '手动增加数据库',
'L_ADD_RECIPIENT' => '增加接收人',
'L_ALL' => '全部',
'L_ANALYZE' => '分析',
'L_ANALYZING_TABLE' => '现在表\'<b>%s</b>\'里的数据正在被分析中。',
'L_ASKDBCOPY' => '你想从数据库 `%s` 复制数据到数据库 `%s` 吗？',
'L_ASKDBDELETE' => '是否要删除数据库 `%s` 的内容？',
'L_ASKDBEMPTY' => '你想清空数据库 `%s` 吗？',
'L_ASKDELETEFIELD' => '你想删除这个字段吗？',
'L_ASKDELETERECORD' => '你确定要删除这个记录吗？',
