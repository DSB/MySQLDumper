...
<br"
    ...
    ." Daten.
<br />Solltest Du nach der"
    ." Wiederherstellung Probleme mit"
    ." Sonderzeichen entdecken, so kannst Du"
    ." versuchen, das Backup mit einer"
...
Achtung:"
    ...
    ." verloren! Lege sicherheitshalber"
...
Achtung:"
    ...
    'L_EMAIL' => "E-Mail",
    'L_EMAILBODY_ATTACH' => "In der Anlage findest du die Sicherung"
    ." deiner MySQL-Datenbank.<br />Sicherung"
    ." der Datenbank `%s`
<br /><br"
...
<br"
    ...
    'L_ENGINE' => "Typ",
    'L_ENTER_DB_INFO' => "Klicke zuerst auf den Button \"zu"
    ...
    'L_FM_ANZ_BU' => "Backups",
    'L_FM_ASKDELETE1' => "Möchtest du die Datei(en)",
    'L_FM_ASKDELETE2' => "wirklich löschen?",
    'L_FM_ASKDELETE3' => "Möchtest du das automatische Löschen"
    ." nach den eingestellten Regeln jetzt"
    ." ausführen?",
    'L_FM_ASKDELETE4' => "Möchtest du alle Backup-Dateien jetzt"
    ." löschen?",
    'L_FM_ASKDELETE5' => "Möchtest du alle Backup-Dateien mit",
    ...
    'L_FM_NOFILE' => "Du hast gar keine Datei ausgewählt!",
    ...
    ." diesem Namen!",
    'L_FM_UPLOADFILEREQUEST' => "Gib bitte eine Datei an.",
    'L_FM_UPLOADFILEREQUEST' => "Bitte gib eine Datei an.",
    ...
    ." aufgetreten!<br />Bitte erzeuge die"
    ." Dateien manuell mit folgendem Inhalt",
    ...
    ." Verzeichnisschutz. Wenn Du einen neuen"
    ." erstellst, wird der alte"
    ." überschrieben!",
    ...
    'L_HTACC_NO_USERNAME' => "Du musst einen Namen eingeben!",
    ...
    ." werden kann. Du kannst die"
    ." gewünschten Pakete jedoch manuell"
    ." herunterladen, entpacken und mit"
    ." Deinem FTP-Programm in den Unterordner"
    ." \"language\" Deiner"
    ." MySQLDumper-Installation speichern."
    ." Anschließend stehen Dir diese hier"
    ." zur Auswahl zur Verfügung.",
    'L_INFO_LASTUPDATE' => "letzte Aktualisierung",
    'L_INFO_LOCATION' => "Du befindest dich auf",
    ...
    'L_MAX_UPLOAD_SIZE' => "Maximale Dateigröße",
    'L_MAX_UPLOAD_SIZE_INFO' => "Wenn Deine Backup-Datei größer als"
    ." das angegebene Limit ist, dann musst"
    ." Du diese per FTP in den"
...
Danach wird diese Datei hier in der"
    ...
    ." gefunden.
Blende die"
    ." Verbindungsparameter ein und gebe den"
    ." Namen Deiner Datenbank manuell ein!",
    'L_NO_DB_FOUND_INFO' => "Die Verbindung zur Datenbank konnte"
    ." erfolgreich hergestellt werden.<br"
    ." />
Deine Zugangsdaten sind gültig und"
...
Die"
    ...
    ." />
Du musst Deine Datenbank nach dem"
    ." Abschluß der Installation unter dem"
    ." Menüpunkt \"Konfiguration\""
    ." \"Verbindungsparameter einblenden\""
    ." angeben.<br />
Bitte begebe Dich nach"
    ." Abschluß der Installation umgehend"
    ." dort hin und trage den Namen Deiner"
    ." Datenbank dort ein.",
    ...
    'L_NO_NAME_GIVEN' => "Du hast keinen Namen angegeben.",
    ...
    ." von Hand angelegt werden (dies kannst"
    ." Du mit Deinem FTP-Programm erledigen):",
    'L_SAVE' => "Speichern",
    ...
    'L_VIEW' => "ansehen",
    'L_VISIT_HOMEPAGE' => "Besuche die Homepage",
    'L_VOM' => "vom",
    'L_WITH' => "mit",
    ...
    ." />
Entweder hat sie/es den falschen"
    ." Besitzer (Owner) oder die falschen"
    ." Rechte (Chmod).<br /> 
Bitte setze die"
    ." richtigen Attribute mit Deinem"
    ." FTP-Programm. <br />
Die Datei oder"
