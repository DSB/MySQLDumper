...
$lang['critical_safemode']="<h3>ATENCI&Oacute;N: no se puede seguir de forma segura!</h3>Los siguientes directorios deben ser creados manualmente en el directorio del Script:<br><div style=\"padding-left:20px;\"><br>work<br>work/backup<br>work/config<br>work/log<br>work/structure</div><br>D&eacute;les a dichos directorios derechos totales (chmod 777).<br>A partir de entonces podr&aacute; usar MySQL Dumper sin problemas de forma segura.";
