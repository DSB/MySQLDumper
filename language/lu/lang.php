...
$lang=array_merge($lang, array(
    ...
    'L_AUTODELETE' => "automatescht Läschen vun Backups",
    'L_BACK' => "zerëck",
    'L_BACKUPFILESANZAHL' => "Am Backup Ordner sinn",
    'L_BACKUPS' => "Backups",
...
Attention: all data will be"
    ...
    'L_CREATE_DATABASE' => "Nei Datebank erstellen",
    'L_CREATE_TABLE_SAVED' => "Definition of table `%s` saved.",
    'L_CREDITS' => "Credits / Hëllëf",
    'L_CRONSCRIPT' => "Cronscript",
    'L_CRON_COMMENT' => "Enter Comment",
    'L_CRON_COMPLETELOG' => "Ganz Ausgab loggen",
...
<br /><br"
    ...
    'L_LOG' => "Log",
    'L_LOGFILENOTWRITABLE' => "Can't write logfile !",
