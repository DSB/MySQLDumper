...
$aus['db'].='<div id="VP" style="display:none;"><table><tr><td>Host / User / Passwort:</td>';
...
$aus['cron'].='<tr><td>'.$lang['new'].':</td><td><input class="text" type="text" size="18" name="cron_savepath_new" value="">&nbsp;.conf</td></tr></table></td>';
...
echo $aus['formende'];
echo '<script language="JavaScript" type="text/javascript">show_pardivs("'.$sel.'");</script>';
