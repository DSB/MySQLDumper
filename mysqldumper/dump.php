...
if (isset($_GET['select_dump_encoding']))
{
	// Erstaufruf -> encoding auswerten
	include_once('./inc/functions_sql.php');
	get_sql_encodings();
	$encodingline=$config['mysql_possible_character_sets'][$_GET['select_dump_encoding']];
...
else
{
	...
	$aus[]=$lang['charset'].': <strong>'.$dump['dump_encoding'].'</strong>';
	...
	else
	{
		...
		$aus[]='<span class="small">'.$out.'</span><br>'
