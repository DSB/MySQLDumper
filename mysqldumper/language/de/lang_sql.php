...
$lang['sql_tabledeleted']="Tabelle `%s` wurde gel&ouml;scht.";
...
$lang['askdbdelete']="M&ouml;chtest Du die Datenbank `%s` samt Inhalt wirklich l&ouml;schen?";
$lang['askdbempty']="M&ouml;chtest Du die Datenbank `%s` wirklich leeren?";
$lang['askdbcopy']="M&ouml;chtest Du den Inhalt der Datenbank `%s` in die Datenbank `%s` kopieren?";
...
$lang['asktableemptykeys']="Soll die Tabelle `%s` geleert werden und die Indizes zur&uuml;ckgesetzt werden?";
$lang['edit']="editiern";
...
Bei Benutzung von Sonderzeichen m&uuml;ssen diese mit \ maskiert werden.
...
$lang['csv_fileopen']="CSV-File &ouml;ffnen";
