...
$lang['info_cronyes']="You can run MySQL Dumper as a Cron job.";
$lang['info_cronno']="Due to your PHP settings (safe_mode=on), you cannot run MySQL Dumper as a Cron job! ";
...
$lang['dbnoempty']="Database name can't be empty !";
