...
<div id="content">
<h3>Sur ce projet</h3>
L'idée pour ce projet est venue de Daniel Schlichtholz.<p>Il a ouvert en 2004 le forum <a href="http://www.mysqldumper.de/board" target="_blank">MySQLDumper</a> et rapidement d'autres développeurs ont écrit de nouveaux scripts ou bien élargi les scripts de Daniel. En peu de temps le simple script de sauvegarde est devenu un imposant projet.<p>Si vous avez des propositions d'améliorations vous pouvez les communiquer dans le Forum MySQLDumper <a href="http://www.mysqldumper.de/board" target="_blank">http://www.daniel-schlichtholz.de/board</a>. <p>Nous vous souhaitons beaucoup de plaisir avec ce projet.<br><p><h4>L'équipe de MySQLDumper</h4>
...
L'adresse est: <a href="http://www.mysqldumper.de/board" target="_blank">
...
<h3>Nos sponsors</h3>
Vous trouverez les sponsors aussi à l'adresse suivante <a class="ul" href="http://www.mysqldumper.de/de/index.php?m=7" target="_blank">Sponsors</a><br>
