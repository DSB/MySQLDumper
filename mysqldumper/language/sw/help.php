...
Daniel Schlichtholz hade iden för detta projekt.<p>2004 startade han forumet <a href="http://www.mysqldumper.de/board" target="_blank">MySQLDumper</a> och väldigt snabbt infann sig ett antal hobby-programmerare som skrev nya skripter och anpassade de skripter som Daniel hade skrivit.<br>På kortaste tid uppstod ett omfångsrikt projekt.<p>Välkommen att yttra dina förbättringsförslag i MySQLDumper-forumet <a href="http://www.mysqldumper.de/board" target="_blank">http://www.mysqldumper.de/board</a>.<p>Vi önskar mycket nytta och nöje med detta projekt.<br><p><h4>MySQLDumper-teamet</h4>
...
Sponsorerna hittar du på <a class="ul" href="http://www.mysqldumper.de/de/index.php?m=7" target="_blank">Sponsorsidan</a><br>
<?php echo MSDFooter();?>
